...
> 当前正式版为 **[v1.4.0](https://github.com/chengweiv5/easy-trip/releases/tag/v1.4.0)**，新增行程长图分享，并优化日历拖动调时和交通显示，可在发布页下载 APK。下方全部截图于 2026-09-23 从最新 `main` 源码（`46af47e`）构建运行后重新采集，包含正式版之后的工作台界面优化，图片均可点击放大。
