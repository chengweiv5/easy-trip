...
> 当前正式版为 **[v1.5.0](https://github.com/chengweiv5/easy-trip/releases/tag/v1.5.0)**，优化全程日历对齐、日期操作按钮和地图工作台，可在发布页下载 APK。下方全部截图于 2026-09-23 从最新 `main` 源码（`46af47e`）构建运行后重新采集，展示本版工作台界面，图片均可点击放大。
