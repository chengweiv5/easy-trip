...
> 当前正式版为 **[v1.3.0](https://github.com/chengweiv5/easy-trip/releases/tag/v1.3.0)**，新增旅行日历与拖动调时，可在发布页下载 APK。源码已增加 **v1.4.0 行程长图分享**，尚未发布对应正式 APK；下方既有截图展示 v1.2.0 的运行效果。
...
长图头部先展示全程日历，停留和交通共用时间轴，每组最多 3 天，更多日期向下续排。未设时间、短时段及重叠内容有完整补充说明；交通可能赶不上下一站时保留原始时间并提示。选择单日也会展示前日跨午夜延续。
