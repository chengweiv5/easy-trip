...
object V1ScenarioFixtures {
    ...
    val scenarios = listOf(
        ...
        scenario(8, "旅行设置", "U06l7P", "y3rP1", null, "existing-trip", "V1FullUiAcceptanceTest#requiredProductSemanticsRemainCatalogued", "工作台 → 更多 → 旅行设置", BlockerCategory.REACHABILITY, "设置页不显示添加一天入口"),
        ...
        scenario(10, "地点详情与编辑", "p4G1tS", null, null, "saved-place-detail", "V1FullUiAcceptanceTest#requiredProductSemanticsRemainCatalogued", "地点池 → 地点卡片", BlockerCategory.REACHABILITY, "地点详情不显示加入行程入口"),
        ...
        scenario(13, "删除旅行确认", "oW9mK", null, null, "trip-with-delete-impact", "V1FullUiAcceptanceTest#dangerousActionsDescribeTheirImpact", "我的旅行 → 删除旅行", BlockerCategory.KEY_INTERACTION, "确认文案说明级联删除影响"),
        scenario(14, "状态规范", "DxZ2a", null, null, "component-states", "V1FullUiAcceptanceTest#blockerAssertionsCoverTheAcceptanceGate", "验收目录 → 状态矩阵", BlockerCategory.SEVERE_CLIPPING),
        scenario(15, "无旅行日", "p7U8B", null, null, "trip-without-days", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "工作台 → 行程", BlockerCategory.CRASH_FREE),
        scenario(16, "工作台更多菜单", "ijpZD", null, null, "existing-trip", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "工作台 → 更多", BlockerCategory.REACHABILITY),
        ...
        scenario(20, "旅程 C 选择", "X3rm1", null, null, "multi-day-add-target", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "地点详情 → 选择旅行日", BlockerCategory.REACHABILITY),
        ...
        scenario(25, "删除旅行日确认", "J7PZ7u", null, null, "day-with-delete-impact", "V1FullUiAcceptanceTest#dangerousActionsDescribeTheirImpact", "工作台 → 日期菜单 → 删除", BlockerCategory.KEY_INTERACTION, "确认文案说明地点和路段影响"),
        ...
        scenario(27, "搜索无结果", "S0psO", null, null, "empty-search-result", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "搜索地点 → 提交无匹配关键字", BlockerCategory.FUNCTIONAL_STATE),
        ...
        scenario(29, "路线失败", "E3EhSv", null, null, "failed-route", "OfflineRecoveryTest#persistedRoutesRecoverInterruptedWorkWithoutTouchingSuccess", "工作台 → 失败路线", BlockerCategory.FUNCTIONAL_STATE),
        scenario(30, "地图权限说明", "EHOHC", null, null, "map-consent-required", "V1FullUiAcceptanceTest#requiredProductSemanticsRemainCatalogued", "首次打开地图能力", BlockerCategory.KEY_INTERACTION, "系统权限前先展示用途说明"),
        ...
        scenario(32, "删除行程项确认", "l2xCsM", null, null, "itinerary-delete-impact", "V1FullUiAcceptanceTest#dangerousActionsDescribeTheirImpact", "行程项 → 删除", BlockerCategory.KEY_INTERACTION, "确认文案说明相邻路线重算影响"),
        scenario(33, "长日期列表", "cRdBn", null, null, "long-date-list", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "长旅行 → 日期列表", BlockerCategory.SEVERE_CLIPPING),
        scenario(34, "定位权限说明", "JFhZ7", null, null, "location-rationale", "OfflineRecoveryTest#reopeningWorkspaceDoesNotRequestLocationPermission", "工作台 → 定位", BlockerCategory.KEY_INTERACTION, "系统权限前先展示定位用途说明"),
        scenario(35, "前往设置", "HYCsZ", null, null, "location-permanently-denied", "OfflineRecoveryTest#reopeningWorkspaceDoesNotRequestLocationPermission", "定位权限说明 → 永久拒绝", BlockerCategory.REACHABILITY),
        ...
        scenario(38, "搜索网络失败", "GJo79", null, null, "search-network-error", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "搜索地点 → 网络失败", BlockerCategory.FUNCTIONAL_STATE),
        ...
        scenario(40, "修改出行日期", "IKTv5", null, null, "dated-trip-settings", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "旅行设置 → 修改日期", BlockerCategory.DATA_CONSISTENCY),
        scenario(41, "加入提交中", "V6RALq", null, null, "add-place-submitting", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "选择旅行日 → 提交", BlockerCategory.KEY_INTERACTION),
        scenario(42, "目标日已删除", "D3XZi", null, null, "stale-add-target", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "选择旅行日 → 目标日被删除 → 提交", BlockerCategory.DATA_CONSISTENCY),
        scenario(43, "撤销成功", "KPBBb", null, null, "undo-delete-success", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "删除地点 → 撤销", BlockerCategory.DATA_CONSISTENCY),
        ...
        scenario(46, "地图加载失败", "U8R5i", null, null, "map-load-error", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "打开工作台 → 地图加载失败", BlockerCategory.CRASH_FREE),
        ...
        scenario(48, "行程修改保存失败", "OOEsk", null, null, "itinerary-save-error", "V1FullUiAcceptanceTest#everyScenarioHasFrameFixtureDevicePathAndAssertions", "行程项编辑 → 保存失败", BlockerCategory.DATA_CONSISTENCY),
    )
    ...
    private fun scenario(
        ...
        journey = journey,
        matrix = matrix,
        launch = ScenarioLaunch(fixture, automation, reachablePath),
        assertions = listOf(
