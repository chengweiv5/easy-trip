...
data class EasyTripSpacing(
    ...
    val large: Dp = 20.dp,
    val xLarge: Dp = 24.dp,
    val dialogContentHorizontal: Dp = 16.dp,
    val dialogContentVertical: Dp = 16.dp,
    val dialogSectionGap: Dp = 12.dp,
    val settingsGrid: Dp = 16.dp,
    val settingsSectionGap: Dp = 16.dp,
    val settingsCardGap: Dp = 8.dp,
    val workspaceOverlayGap: Dp = 20.dp,
    val workspaceControlGap: Dp = 8.dp,
)
...
data class EasyTripSizes(
    ...
    val dialogFieldHeight: Dp = 58.dp,
    ...
    val workspaceIconSize: Dp = 14.dp,
    val searchHeaderHeight: Dp = 48.dp,
    val searchHeaderCornerRadius: Dp = 12.dp,
