    ...
    Column(
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                Spacer(Modifier.width(28.dp).height(1.dp).border(0.5.dp, EasyTripBorder))
                StepNumber("2", false)
                Text("开始规划", color = MaterialTheme.colorScheme.onSurfaceVariant, style = MaterialTheme.typography.labelMedium)
            }
            CreateTripFormFields(state, onAction, initialDateMillis)
            Column(
                ...
                Text(
                    ...
                    color = if (state.nameError != null || state.dayCountError != null || state.dateError != null) {
