...
import java.time.*
@Entity(tableName="trips") data class TripEntity(@PrimaryKey val id:String,val name:String,val timeMode:TimeMode,val startDate:LocalDate?=null,val travelMode:TravelMode,val createdAt:Instant,val updatedAt:Instant,@ColumnInfo(defaultValue="0") val hasTraveled:Boolean=false)
