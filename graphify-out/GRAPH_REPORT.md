...
## Corpus Check
- 316 files · ~170,655 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4556 nodes · 9740 edges · 248 communities (212 shown, 36 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 681 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b5fdafa8`
...
1. `GeoPoint` - 172 edges
2. `PlaceCandidate` - 126 edges
3. `SavedPlace` - 91 edges
4. `TripDay` - 89 edges
5. `TravelMode` - 72 edges
6. `TripWorkspaceViewModel` - 64 edges
7. `CreateTrip` - 60 edges
8. `TransportMode` - 59 edges
...
Cohesion: 0.08
Nodes (10): Coordinator, DayItineraryViewModelTest, Itineraries, CompletableDeferred, Flow, ItineraryRepository, kotlinx, Legs (+2 more)

### Community 16 - "MapUiModel"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (10): RoomSavedPlaceRepositoryTest, IdFactory, T, MutableClock, RoomTripRepositoryTest, TripDateRangeRoomTest, V1PencilFlowTest, RoomTripRepository (+2 more)
...
Cohesion: 0.05
Nodes (12): com, CreateTrip, Flow, RecordingTripRepository, Flow, DayDeletion, InsertSide, AFTER (+4 more)
...
### Community 41 - "TravelMode"
Cohesion: 0.09
Nodes (12): TravelMode, FLEXIBLE, SELF_DRIVE, Factory, androidx, com, Job, StateFlow (+4 more)
...
Cohesion: 0.15
Nodes (10): WholeTripItineraryContentTest, EmptyState(), Composable, Modifier, ItineraryEmptyIllustration(), Modifier, dayHeading(), Modifier (+2 more)
...
Cohesion: 0.19
Nodes (14): CompactPrimaryButton(), CompactSecondaryButton(), AddTripDayContent(), EditItineraryItemContent(), Modifier, Modifier, SavedPlaceRow(), Composable (+6 more)
...
Cohesion: 0.12
Nodes (21): PlaceDetailPanelTest, Modifier, PlaceDetailContent(), PlaceDetailDialog(), CancelEdit, Delete, Dismiss, Modifier (+13 more)
...
Cohesion: 0.11
Nodes (8): Itineraries, ItineraryRepository, Places, PoiHost, Trips, WorkspaceFlowTest, MapPoiUi, TripWorkspaceScreen()
...
Cohesion: 0.11
Nodes (18): CoroutineScope, PlaceSearchDataSource, V2AcceptanceTest, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, AppNavigation(), AppNavigationDependencies (+10 more)
...
### Community 90 - "DateRangeDeletionCounts"
Cohesion: 0.08
...
Cohesion: 0.23
Nodes (4): androidx, PlaceSearchContentTest, PlaceSearchState, PlaceSearchUiState
...
### Community 96 - "AddToItineraryUiState"
Cohesion: 0.21
...
### Community 98 - "TestSavedPlaces"
Cohesion: 0.15
Nodes (7): com, Flow, com, com, TestSavedPlaces, com, PlaceSearchRoute()

### Community 99 - "GeoPoint"
Cohesion: 0.07
Nodes (15): PlaceSearchDataSource, PlacePoolFlowTest, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, WorkspacePlacePoolLayoutTest, GeoPoint, Modifier (+7 more)
...
### Community 123 - ".modelWithResult"
Cohesion: 0.16
Nodes (3): PendingCollectionRemoval, decidePlaceSearchBack(), reducePlaceSearchBack()
...
Cohesion: 0.22
Nodes (3): CascadeDeleteTest, ItineraryRepository, RoomItineraryRepository
...
Cohesion: 0.11
Nodes (11): AmapMapHost, TestMapHost, AmapMapHost, RecordingHost, MapLayer, SATELLITE_ROAD, STANDARD, InMemoryMapPreferences (+3 more)
...
Cohesion: 0.12
Nodes (10): TransportMode, DRIVE, TAXI, TRANSIT, WALK, defaultRecommendMode(), haversineMeters(), Flow (+2 more)
...
Cohesion: 0.11
Nodes (12): AmapPrivacyGate, AmapPlaceDataSource, CallbackBoundary, PoiSearch, CallbackBoundary, com, parsePoiSearchResponse(), parsePlaces() (+4 more)
...
Cohesion: 0.31
Nodes (7): mapWholeTripDays(), toItineraryItemUi(), toRouteErrorSummary(), toRouteLegUi(), WholeTripDayUi, DayMapSnapshot, WholeTripItineraryMapperTest
...
Cohesion: 0.09
Nodes (4): V1AcceptanceTest, RoomRouteLegRepository, RouteDataSource, RouteResult

### Community 214 - "12. 搜索状态视觉"
Cohesion: 0.33
Nodes (6): 12.1 初始, 12.2 加载, 12.3 结果, 12.4 无结果, 12.5 网络失败, 12. 搜索状态视觉

### Community 216 - "ByteArray"
Cohesion: 0.67
...
### Community 243 - "PlaceCandidate"
Cohesion: 0.08
Nodes (12): EditingPlaces, ItineraryRepository, PlaceCandidate, PlaceSearchDataSource, AlreadySaved, Flow, PlaceTag, Saved (+4 more)
...
## Knowledge Gaps
- **971 isolated node(s):** `guard-adb-install.sh script`, `TRIP_LIST`, `CREATE_TRIP`, `DATE_PICKER`, `WORKSPACE` (+966 more)
...
- **Why does `GeoPoint` connect `GeoPoint` to `MapUiModelMapperTest`, `FakeRepository`, `PlacePoolUiState`, `V1ScenarioExecutable.kt`, `DayItineraryUiState`, `RouteLegRepository`, `TripWorkspaceContent`, `MapUiModel`, `RoomItineraryRepository`, `CreateTrip`, `TransportMode`, `DayItinerary`, `AmapPlaceDataSource.kt`, `decideCollectionToggle`, `reduceMapInteraction`, `ItineraryUiModels.kt`, `.Content`, `PlacePoolViewModel`, `FakeTrips`, `RoomRouteLegRepositoryTest`, `PlaceSearchViewModelTest`, `TripWorkspaceViewModel`, `AmapRouteDataSource`, `.setContent`, `AmapServiceException`, `AmapMapHost`, `WorkspaceFlowTest`, `WorkspaceFlowTest.kt`, `RoomRouteLegRepository`, `RealAmapMapHost`, `PolylineCodec`, `AmapRouteDataSource.kt`, `TripDay`, `MapFacade.kt`, `PlaceSearchUiState`, `TestSavedPlaces`, `RoutePlannerTest`, `MapViewportControllerTest`, `TripWorkspaceNavigationStateTest`, `PlaceCandidate`, `SearchSource`, `DelayedDeletePlaces`, `SearchMapFocusTest.kt`, `AddPlacesRequest`, `.modelWithResult`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `PlaceCandidate` connect `PlaceCandidate` to `MapUiModelMapperTest`, `Flow`, `V1ScenarioExecutable.kt`, `Trips`, `DayItineraryUiState`, `PlaceSearchReducer`, `RoomItineraryRepository`, `CreateTrip`, `Places`, `Places`, `Legs`, `AmapPlaceDataSource.kt`, `decideCollectionToggle`, `reduceMapInteraction`, `PlacePoolViewModel`, `CompactSecondaryButton`, `PlaceSearchViewModel`, `PlaceSearchViewModelTest`, `TripWorkspaceViewModel`, `.setContent`, `PlaceSearchContent.kt`, `WorkspaceFlowTest`, `WorkspaceFlowTest.kt`, `RoomRouteLegRepository`, `MapFacade.kt`, `PlaceSearchUiState`, `AddToItineraryUiState`, `TestSavedPlaces`, `GeoPoint`, `PlacePoolContent`, `SearchSource`, `DelayedDeletePlaces`, `SearchMapFocusTest.kt`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `TripRepository` connect `TripRepository` to `TripService`, `Trips`, `DayItineraryViewModel`, `Trips`, `CreateTrip`, `Trips`, `FakeRepository`, `DayItinerary`, `TravelMode`, `LongNameTrips`, `FakeRepository`, `FakeTrips`, `FakeRepository`, `TripWorkspaceViewModel`, `TripSummary`, `FakeTripRepository`, `WorkspaceFlowTest`, `WorkspaceFlowTest.kt`, `DateRangeDeletionCounts`, `Trips`, `TripWorkspaceNavigationStateTest`, `PlaceCandidate`, `SearchMapFocusTest.kt`?**
