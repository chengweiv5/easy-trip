...
## Corpus Check
- 316 files · ~170,514 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4552 nodes · 9729 edges · 254 communities (210 shown, 44 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 679 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `830114af`
...
## Communities (254 total, 44 thin omitted)
...
### Community 11 - "WorkspaceFlowTest.kt"
Cohesion: 0.06
Nodes (23): Flow, Flow, Flow, Flow, ItineraryRepository, AlreadySaved, Saved, SavePlaceResult (+15 more)

### Community 13 - "DayItineraryUiState"
Cohesion: 0.13
Nodes (24): WorkspacePlacePoolLayoutTest, DayItineraryUiState, PlacePoolUiState, Composable, Modifier, TripWorkspaceContent(), WorkspacePageMessage(), WorkspaceReadyContent() (+16 more)

### Community 14 - "TripWorkspaceRoute.kt"
Cohesion: 0.08
Nodes (37): ConfirmationUiModel, CrossDayMoveDraft, ItineraryDeleteConfirmation, ItineraryEditDraft, RouteModeEditDraft, addOverlayToPresent(), AppendDayCompletionDecision, canDismissAddOverlay() (+29 more)
...
Cohesion: 0.07
Nodes (9): RoomSavedPlaceRepositoryTest, IdFactory, T, RoomTripRepositoryTest, TripDateRangeRoomTest, Flow, RoomTripRepository, CreateTrip (+1 more)
...
Cohesion: 0.08
Nodes (11): com, CreateTrip, Flow, RecordingTripRepository, TravelMode, FLEXIBLE, SELF_DRIVE, Flow (+3 more)
...
Cohesion: 0.11
Nodes (11): WorkspacePermissionFlowTest, T, LocationPermissionCoordinator, LocationPermissionSnapshot, PermissionCopy, PermissionExplanationContent(), PermissionKind, DEVICE_LOCATION (+3 more)
...
Cohesion: 0.16
Nodes (10): GeoPoint, Flow, DayItinerary, ItineraryItem, ItineraryPlace, Flow, Result, PolylineCodec (+2 more)
...
### Community 48 - "consumeWorkspaceSearchReturn"
Cohesion: 0.17
Nodes (9): consumeWorkspaceSearchReturn(), publishWorkspaceSearchReturn(), shouldConsumeSearchReturn(), WorkspaceSection, ITINERARY, PLACE_POOL, TestOwner, WorkspaceSearchReturnNavigationTest (+1 more)

### Community 49 - "FakeTrips"
Cohesion: 0.12
Nodes (4): FakeTrips, com, CreateTrip, java

### Community 50 - "Trips"
Cohesion: 0.09
Nodes (3): com, LongNameTrips, Trips
...
Cohesion: 0.14
Nodes (9): Add, FakeCoordinator, FakeItineraries, ItineraryEditingTest, ItineraryRepository, Move, Timing, DayItinerarySheet() (+1 more)
...
Cohesion: 0.09
Nodes (10): PendingCollectionRemoval, decidePlaceSearchBack(), reducePlaceSearchBack(), ControlledSearchSource, FakeSavedPlaces, IgnoringCancellationSearchSource, ImmediateSearchSource, PlaceSearchDataSource (+2 more)
...
Cohesion: 0.11
Nodes (22): PlaceDetailPanelTest, SavedPlace, Modifier, PlaceDetailContent(), PlaceDetailDialog(), CancelEdit, Delete, Dismiss (+14 more)
...
### Community 78 - "Legs"
Cohesion: 0.09
Nodes (7): Itineraries, ItineraryRepository, Legs, Places, PoiHost, WorkspaceFlowTest, MapPoiUi
...
Cohesion: 0.12
Nodes (16): CreateTrip, PlaceSearchDataSource, PlaceSearchDataSource, AppNavigation(), AppNavigationDependencies, AppNavigationObserver, android, androidx (+8 more)
...
### Community 90 - "WorkspaceNavigationTest"
Cohesion: 0.23
...
Cohesion: 0.11
Nodes (19): Back, CancelEdit, ConfirmRemoval, DismissRemovalConfirmation, ExitDestination, Ignore, OpenDetail, PlaceSearchAction (+11 more)
...
### Community 99 - "RoomSavedPlaceRepository"
Cohesion: 0.07
Nodes (11): CascadeDeleteTest, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, V1AcceptanceTest, AppContainer, CoroutineScope (+3 more)
...
Cohesion: 0.05
Nodes (13): Places, PlaceSearchDataSource, Flow, Flow, PlaceTag, SavedPlaceRepository, LazyListState, Modifier (+5 more)
...
### Community 143 - "DateRangeDeletionCounts"
Cohesion: 0.08
Nodes (4): com, CreateTrip, Trips, DateRangeDeletionCounts

### Community 146 - "RouteLegEntity"
Cohesion: 0.17
Nodes (5): OfflineRecoveryTest, ItineraryItemEntity, ItineraryRepository, RoomItineraryRepository, RouteLegEntity
...
### Community 160 - "TransportMode"
Cohesion: 0.07
Nodes (15): MutableClock, TimeMode, DATED, DRAFT, TransportMode, DRIVE, TAXI, TRANSIT (+7 more)
...
Cohesion: 0.05
Nodes (9): AppIconResourceTest, V1PencilFlowTest, CascadeCountDao, EasyTripDatabase, com, SchemaItineraryDao, SchemaPlaceDao, SchemaRouteDao (+1 more)
...
### Community 203 - "EasyTripPrimaryButton"
Cohesion: 0.20
...
### Community 211 - "AmapConsentToken"
Cohesion: 0.12
...
### Community 219 - "DayItineraryViewModel.kt"
Cohesion: 0.29
Nodes (5): Factory, StateFlow, T, ViewModel, ViewModelProvider

### Community 220 - "TripListContent"
Cohesion: 0.32
...
### Community 230 - "RoutePlannerTest"
Cohesion: 0.38
...
### Community 248 - "Itineraries"
Cohesion: 0.09
Nodes (9): Itineraries, AmapMapHost, ItineraryRepository, Lifecycle, LifecycleOwner, Places, RecordingHost, SearchMapFocusTest (+1 more)

### Community 255 - "Task 4 报告"
Cohesion: 0.15
Nodes (12): Fix round 1, Fix round 2, GREEN, RED, RED / GREEN, RED / GREEN, Task 4 报告, 修复 (+4 more)

## Knowledge Gaps
- **969 isolated node(s):** `guard-adb-install.sh script`, `TRIP_LIST`, `CREATE_TRIP`, `DATE_PICKER`, `WORKSPACE` (+964 more)
...
- **Why does `GeoPoint` connect `GeoPoint` to `MapUiModelMapperTest`, `SavedPlaceRepository`, `FakeRepository`, `TripWorkspaceContentTest`, `V1ScenarioExecutable.kt`, `V1ScenarioExecutableFactory`, `PlaceSearchReducer`, `RouteStatus`, `WorkspaceFlowTest.kt`, `DayItineraryUiState`, `.model`, `CreateTrip`, `TransportMode`, `MapUiModel`, `AmapServiceException`, `decideCollectionToggle`, `TripDay`, `reduceMapInteraction`, `EasyTripDatabase`, `ItineraryUiModels.kt`, `.Content`, `PlacePoolViewModel`, `FakeItineraries`, `CompactSecondaryButton`, `PlaceSearchViewModelTest`, `TripWorkspaceViewModel`, `AmapSmokeTest`, `SavedPlace`, `RouteRequest`, `AmapMapHost`, `MapFacade.kt`, `.searchCollectionAndMapFlowUsesProductionNavigationState`, `Legs`, `MapViewportRenderingPolicyTest`, `AppNavigation.kt`, `RoomRouteLegRepository`, `RealAmapMapHost`, `parsePlaces`, `AmapRouteDataSource.kt`, `ViewportReason`, `PlaceCandidate`, `RoomSavedPlaceRepository`, `RoutePlannerTest`, `MapViewportControllerTest`, `TripWorkspaceNavigationStateTest`, `EditingPlaces`, `DelayedDeletePlaces`, `Itineraries`, `SavedPlaces`, `AddPlacesRequest`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `PlaceCandidate` connect `PlaceCandidate` to `MapUiModelMapperTest`, `SavedPlaceRepository`, `V1ScenarioExecutable.kt`, `Trips`, `V1ScenarioExecutableFactory`, `PlaceSearchReducer`, `WorkspaceFlowTest.kt`, `TripWorkspaceRoute.kt`, `CreateTrip`, `Places`, `Places`, `AmapServiceException`, `decideCollectionToggle`, `reduceMapInteraction`, `EasyTripDatabase`, `PlacePoolViewModel`, `CompactSecondaryButton`, `PlaceSearchViewModel`, `PlaceSearchViewModelTest`, `TripWorkspaceViewModel`, `SavedPlace`, `PlaceSearchContent.kt`, `MapFacade.kt`, `.searchCollectionAndMapFlowUsesProductionNavigationState`, `Legs`, `AppNavigation.kt`, `parsePlaces`, `ViewportReason`, `RoomSavedPlaceRepository`, `PlacePoolContent`, `EditingPlaces`, `DelayedDeletePlaces`, `Itineraries`, `SavedPlaces`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `TripRepository` connect `TravelMode` to `TripService`, `Trips`, `WorkspaceFlowTest.kt`, `DateRangeDeletionCounts`, `DayItineraryViewModelTest`, `CreateTrip`, `Trips`, `FakeRepository`, `Legs`, `TripSettingsViewModel`, `FakeTrips`, `Trips`, `FakeRepository`, `FakeRepository`, `TripWorkspaceViewModel`, `TripSummary`, `FakeTripRepository`, `AppNavigation.kt`, `DayItineraryViewModel.kt`, `Trips`, `Trips`?**
