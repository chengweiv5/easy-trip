...
## Corpus Check
- 276 files · ~142,043 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3811 nodes · 8388 edges · 191 communities (154 shown, 37 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 551 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6799483d`
...
Cohesion: 0.15
Nodes (9): ComposeScenario, com, ScenarioFixture, ScenarioPath, V1ScenarioExecutable, V1ScenarioExecutableFactory, DayItineraryUiState, RouteLegUi (+1 more)
...
Cohesion: 0.06
Nodes (21): CascadeDeleteTest, PlaceSearchDataSource, PlacePoolFlowTest, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, AmapPrivacyGate, GeoPoint (+13 more)

### Community 14 - "TripDay"
Cohesion: 0.05
Nodes (29): Flow, Flow, Flow, Flow, TravelMode, FLEXIBLE, SELF_DRIVE, Flow (+21 more)
...
Cohesion: 0.11
Nodes (17): V1FullUiAcceptanceTest, BlockerCategory, BASIC_ACCESSIBILITY, CRASH_FREE, DATA_CONSISTENCY, FUNCTIONAL_STATE, KEY_INTERACTION, REACHABILITY (+9 more)
...
### Community 28 - "SavedPlaceRepository"
Cohesion: 0.18
Nodes (9): Flow, SavedPlaceRepository, Flow, ItineraryRepository, observeSnapshots(), restoreWorkspaceTab(), WorkspaceTab, ITINERARY (+1 more)
...
Cohesion: 0.23
Nodes (9): AppNavigation(), AppNavigationDependencies, AppNavigationObserver, android, tripSearchRoute(), AmapPlaceDataSource, PlaceSearchRoute(), CreateTripRoute() (+1 more)
...
### Community 57 - "Dp"
Cohesion: 0.10
Nodes (31): CompactPrimaryButton(), CompactSecondaryButton(), AddTripDayContent(), EditItineraryItemContent(), Modifier, Modifier, SelectPlacesContent(), Modifier (+23 more)
...
Cohesion: 0.05
Nodes (30): Flow, RouteStatus, CALCULATING, FAILED, PENDING, SUCCESS, WAITING_NETWORK, TransportMode (+22 more)
...
### Community 93 - "PlacePoolUiState"
Cohesion: 0.10
Nodes (25): com, TripWorkspaceContentTest, PlacePoolUiState, Composable, Modifier, TripWorkspaceContent(), WorkspacePageMessage(), WorkspaceReadyContent() (+17 more)
...
Cohesion: 0.17
Nodes (8): consumeWorkspaceSearchReturn(), androidx, com, publishWorkspaceSearchReturn(), WorkspaceSearchReturnViewModel, TestOwner, WorkspaceSearchReturnNavigationTest, ViewModelStoreOwner
...
### Community 133 - "AmapPrivacyGate.kt"
Cohesion: 0.14
Nodes (7): AmapPrivacyStateMachine, ConsentRegistry, ConsentSnapshot, StateFlow, TestConsentGate, AmapPrivacyStateMachineTest, ConsentRevocationTest
...
### Community 159 - "WholeTripItineraryContent"
Cohesion: 0.14
...
### Community 161 - "RoomDeleteImpactProviderTest.kt"
Cohesion: 0.11
...
Cohesion: 0.27
Nodes (3): DayDeleteImpact, DeleteImpactProvider, FakeImpacts
...
- **Why does `GeoPoint` connect `GeoPoint` to `reduceMapInteraction`, `MapUiModelMapperTest`, `FakeRepository`, `PlaceSearchReducer`, `V1ScenarioExecutableFactory`, `V1ScenarioExecutable.kt`, `RealAmapMapHost`, `TripDay`, `CreateTrip`, `DelayedDeletePlaces`, `parsePlaces`, `TestSavedPlaces`, `SavedPlaceRepository`, `AmapServiceException`, `AmapSmokeTest`, `PlaceSearchState`, `PlacePoolViewModelTest`, `FakeTrips`, `RoutePlannerTest`, `Dp`, `.searchCollectionMapAndRestorationFlow`, `PlaceSearchViewModel`, `TripWorkspaceViewModel`, `TripWorkspaceNavigationStateTest`, `decideCollectionToggle`, `MapPoiUi`, `parsePoiSearchResponse`, `.Content`, `Legs`, `TransportMode`, `PlacePoolUiState`, `MapViewportControllerTest`, `AmapRouteDataSource.kt`, `MapUiModel`, `MapView`, `RoomRouteLegRepository`, `AddPlacesRequest`, `.mapDetailBackThenPlaceEditRendersNewTarget`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `TripRepository` connect `TripDay` to `FakeTripRepository`, `TripSettingsViewModel`, `Trips`, `Trips`, `DayItineraryViewModelTest`, `CreateTrip`, `Trips`, `DateRangeDeletionCounts`, `SavedPlaceRepository`, `Trips`, `TripListViewModel`, `RecordingTripRepository`, `Legs`, `FakeRepository`, `AppNavigation.kt`, `FakeRepository`, `FakeTrips`, `FakeRepository`, `TestTripRepository`, `TripWorkspaceNavigationStateTest`, `FakeTripRepository`, `Legs`, `TransportMode`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `RouteLegRepository` connect `TripDay` to `RoomRouteLegRepository`, `FakeRepository`, `Legs`, `Trips`, `Legs`, `AppNavigation.kt`, `Legs`, `DayItineraryViewModelTest`, `Legs`, `FakeTrips`, `Legs`, `TransportMode`, `Trips`, `SavedPlaceRepository`?**
