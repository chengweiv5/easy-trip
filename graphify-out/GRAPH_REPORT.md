...
## Corpus Check
- 299 files · ~157,503 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4186 nodes · 8916 edges · 223 communities (174 shown, 49 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 602 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `69c8b130`
...
Cohesion: 0.13
Nodes (9): CorruptRoute, MapMarkerUi, MapPolylineUi, MapRouteLabelUi, MapUiModelMapper, mapViewportPoints(), OccurrenceUi, routePalette() (+1 more)
...
### Community 23 - "ItineraryItemEntity"
Cohesion: 0.14
...
Cohesion: 0.05
Nodes (28): Flow, Flow, Flow, TravelMode, FLEXIBLE, SELF_DRIVE, ItineraryRepository, Flow (+20 more)
...
Cohesion: 0.14
Nodes (11): ClearedProbe, ViewModel, WorkspaceSearchReturnNavEntryTest, shouldConsumeSearchReturn(), WorkspaceSection, ITINERARY, PLACE_POOL, WorkspaceSearchReturn (+3 more)

### Community 42 - "View"
Cohesion: 0.05
Nodes (9): AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost (+1 more)

### Community 43 - "TagEntity"
Cohesion: 0.10
...
Cohesion: 0.10
Nodes (24): PlacePoolFlowTest, WorkspacePermissionFlowTest, CompactPrimaryButton(), CompactSecondaryButton(), AddToItineraryUiState, AddTripDayContent(), EditItineraryItemContent(), Modifier (+16 more)

### Community 58 - "WorkspaceItineraryContent"
Cohesion: 0.09
Nodes (17): ItineraryScopeRailTest, WholeTripItineraryContentTest, ItineraryScopeRail(), Modifier, ScopeItem(), WholeTripDayUi, Modifier, modeLabel() (+9 more)
...
Cohesion: 0.09
Nodes (9): TripDeleteImpact, com, CompletableDeferred, CreateTrip, Flow, TestImpacts, TestTripRepository, TripListViewModelTest (+1 more)
...
Cohesion: 0.11
Nodes (14): Flow, GeoPoint, DayItinerary, ItineraryItem, ItineraryPlace, Flow, mapWholeTripDays(), toRouteErrorSummary() (+6 more)
...
Cohesion: 0.07
Nodes (22): AmapMapHost, PlaceSearchDataSource, RecordingHost, PlaceSearchDataSource, CreateTrip, PlaceSearchDataSource, PlaceSearchDataSource, AppNavigation() (+14 more)
...
### Community 90 - "EasyTripDatabase"
Cohesion: 0.07
Nodes (8): RoomRouteLegRepositoryTest, V1AcceptanceTest, CoroutineScope, V2AcceptanceTest, EasyTripDatabase, com, RoomRouteLegRepository, RoomDatabase
...
Cohesion: 0.05
Nodes (24): MapScope, PLACE_POOL, SINGLE_DAY, WHOLE_TRIP, MapViewportRequest, ViewportReason, INITIAL, PLACE_SET_CHANGED (+16 more)
...
Cohesion: 0.06
Nodes (23): RouteStatus, CALCULATING, FAILED, PENDING, SUCCESS, WAITING_NETWORK, TransportMode, DRIVE (+15 more)
...
### Community 157 - "TripWorkspaceContent"
Cohesion: 0.13
...
Cohesion: 0.09
Nodes (19): Flow, PlaceCandidate, PlaceSearchDataSource, Flow, RoomSavedPlaceRepository, AlreadySaved, Flow, PlaceTag (+11 more)
...
### Community 164 - "V1PencilFlowTest.kt"
Cohesion: 0.18
...
Cohesion: 0.12
Nodes (7): ItineraryRepository, java, PlaceSearchDataSource, ItineraryRepository, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource
...
Cohesion: 0.50
Nodes (4): Failed, Ready, RouteLegUiState, WaitingForNetwork
...
### Community 204 - "AmapComposeMapTest.kt"
Cohesion: 0.18
Nodes (10): Lifecycle, LifecycleOwner, Bundle, ComponentActivity, MainActivity, toMapPoiUi(), MapMarkerKind, SAVED_ITINERARY (+2 more)
...
## Knowledge Gaps
- **811 isolated node(s):** `guard-adb-install.sh script`, `TRIP_LIST`, `CREATE_TRIP`, `DATE_PICKER`, `WORKSPACE` (+806 more)
...
- **Why does `GeoPoint` connect `GeoPoint` to `MapUiModelMapperTest`, `FakeRepository`, `PlacePoolUiState`, `PlaceSearchReducer`, `V1ScenarioExecutableFactory`, `TransportMode`, `RealAmapMapHost`, `CreateTrip`, `RoutePlannerTest`, `TestSavedPlaces`, `TripDay`, `TripWorkspaceContent`, `TripWorkspaceNavigationStateTest`, `PlaceCandidate`, `MapUiModel`, `Itineraries`, `AmapServiceException`, `.referencedSavedResultRequiresConfirmationAndDismissPreservesData`, `Places`, `SavedPlaces`, `PlacePoolViewModel`, `FakeLegs`, `EditingPlaces`, `CompactSecondaryButton`, `PlaceSearchViewModel`, `TripWorkspaceViewModel`, `AmapSmokeTest`, `parsePlaces`, `.model`, `AmapComposeMapTest.kt`, `SelectablePill`, `TripWorkspaceScreen`, `AppNavigation.kt`, `AmapPlaceDataSource.kt`, `reduceMapInteraction`, `EasyTripDatabase`, `SearchMapFocusTest`, `V1ScenarioExecutable.kt`, `ItineraryScope`, `AmapRouteDataSource.kt`, `PlaceSearchState`, `PlacePoolContent`, `DelayedDeletePlaces`, `AddPlacesRequest`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `PlaceCandidate` connect `PlaceCandidate` to `MapUiModelMapperTest`, `PlaceSearchReducer`, `Trips`, `V1ScenarioExecutableFactory`, `CreateTrip`, `TestSavedPlaces`, `Places`, `TripDay`, `Itineraries`, `Legs`, `.referencedSavedResultRequiresConfirmationAndDismissPreservesData`, `Places`, `SavedPlaces`, `TripWorkspaceRoute.kt`, `PlacePoolViewModel`, `EditingPlaces`, `CompactSecondaryButton`, `PlaceSearchViewModel`, `TripWorkspaceViewModel`, `PlaceSearchContent.kt`, `parsePlaces`, `GeoPoint`, `TripWorkspaceScreen`, `AppNavigation.kt`, `AmapPlaceDataSource.kt`, `reduceMapInteraction`, `EasyTripDatabase`, `V1ScenarioExecutable.kt`, `MapLayerFlowTest`, `PlaceSearchState`, `PlacePoolContent`, `DelayedDeletePlaces`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `TripRepository` connect `TripDay` to `FakeTripRepository`, `TripSettingsViewModel`, `Trips`, `Trips`, `DayItineraryViewModelTest`, `FakeRepository`, `CreateTrip`, `TripListViewModel`, `Trips`, `PlaceCandidate`, `Legs`, `DateRangeApply`, `FakeRepository`, `Trips`, `DateRangeDeletionCounts`, `FakeRepository`, `TripWorkspaceViewModel`, `TestTripRepository`, `RecordingTripRepository`, `FakeTripRepository`, `AppNavigation.kt`, `Trips`, `FakeTrips`, `Trips`?**
