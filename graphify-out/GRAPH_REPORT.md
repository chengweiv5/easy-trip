...
## Corpus Check
- 292 files · ~159,049 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4042 nodes · 8725 edges · 204 communities (163 shown, 41 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 584 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cb75df8d`
...
Cohesion: 0.06
Nodes (27): OfflineRecoveryTest, RoomDeleteImpactProviderTest, EasyTripDatabase, com, SchemaPlaceDao, SchemaRouteDao, TransportMode, DRIVE (+19 more)
...
Cohesion: 0.12
Nodes (14): InMemoryLocationPermissionRequestStore, StateFlow, T, LocationPermissionCoordinator, LocationPermissionRequestStore, LocationPermissionSnapshot, OpenApplicationSettings, RequestLocationPermission (+6 more)
...
Cohesion: 0.10
Nodes (8): Flow, InsertSide, AFTER, BEFORE, Flow, TripRepository, TripWithDays, Flow
...
### Community 34 - "AddToItineraryUiState"
Cohesion: 0.20
Nodes (13): ConfirmationUiModel, AddToItineraryUiState, ItineraryDeleteConfirmation, ItineraryEditDraft, addOverlayToPresent(), canDismissAddOverlay(), canDismissWorkspaceOverlay(), confirmation() (+5 more)
...
Cohesion: 0.24
Nodes (9): CreateTripUiState, CreateTripViewModel, Factory, CreationExtras, Job, StateFlow, T, ViewModel (+1 more)
...
### Community 64 - "RoomTripRepository"
Cohesion: 0.13
...
Cohesion: 0.16
Nodes (4): SavedStateHandle, Trips, Trips, TripWorkspaceNavigationStateTest
...
Cohesion: 0.17
Nodes (10): ItineraryScopeRailTest, ItineraryScopeRail(), Modifier, ScopeItem(), Modifier, SelectTargetDayContent(), Modifier, PaddingValues (+2 more)

### Community 74 - "DateRangeDeletionCounts"
Cohesion: 0.09
...
Cohesion: 0.19
Nodes (10): AppNavigation(), AppNavigationDependencies, AppNavigationObserver, android, com, tripSearchRoute(), WorkspaceSearchReturnViewModel, PlaceSearchRoute() (+2 more)
...
### Community 88 - "Legs"
Cohesion: 0.07
Nodes (6): Itineraries, ItineraryRepository, Legs, Places, SavedPlaces, SearchMapFocusTest
...
Cohesion: 0.07
Nodes (17): PlaceSearchDataSource, PlacePoolFlowTest, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, GeoPoint, Flow, DayItinerary (+9 more)
...
Cohesion: 0.17
Nodes (15): ItineraryItemCard(), ItineraryItemRow(), Color, Dp, Modifier, semanticsActions(), ItineraryPlaceRow(), Failed (+7 more)
...
### Community 115 - "validateCreateTrip"
Cohesion: 0.27
...
### Community 130 - "MapMarkerKind"
Cohesion: 0.50
Nodes (4): MapMarkerKind, SAVED_ITINERARY, SAVED_PLACE_POOL, UNSAVED_SEARCH

### Community 132 - "PlacePoolUiState"
Cohesion: 0.09
Nodes (24): WorkspacePlacePoolLayoutTest, androidx, com, TripWorkspaceContentTest, PlacePoolUiState, SavedPlaceRowUi, Composable, Modifier (+16 more)
...
### Community 136 - "AmapPrivacyGate"
Cohesion: 0.15
Nodes (4): AmapMapViewAttachSmokeTest, AmapPrivacyGate, AmapPrivacyStateMachine, AmapPrivacyStateMachineTest
...
### Community 157 - "MapLayerFlowTest"
Cohesion: 0.32
Nodes (3): FakeMapPreferences, Role, MapLayerFlowTest

### Community 159 - "WorkspaceSearchReturnNavEntryTest"
Cohesion: 0.25
Nodes (3): ClearedProbe, ViewModel, WorkspaceSearchReturnNavEntryTest

### Community 161 - "PlaceCandidate"
Cohesion: 0.05
Nodes (18): CascadeDeleteTest, Flow, com, Flow, com, com, TestSavedPlaces, TripDateRangeRoomTest (+10 more)
...
### Community 179 - "PermissionExplanationContent"
Cohesion: 0.15
Nodes (9): WorkspacePermissionFlowTest, PermissionCopy, PermissionExplanationContent(), Modifier, WorkspaceMapFallback(), PermissionKind, DEVICE_LOCATION, DEVICE_LOCATION_SETTINGS (+1 more)

### Community 180 - "WorkspaceBackDecision"
Cohesion: 0.50
Nodes (4): WorkspaceBackDecision, CloseOverlay, Ignore, LeaveWorkspace

### Community 181 - "CreateTripContent"
Cohesion: 0.39
Nodes (4): CreateTripContentTest, CreateTripContent(), Modifier, StepNumber()

### Community 184 - "FakeTrips"
Cohesion: 0.14
...
### Community 186 - "TimeMode"
Cohesion: 0.29
Nodes (3): TimeMode, DATED, DRAFT

### Community 189 - "WholeTripItineraryContent"
Cohesion: 0.17
Nodes (10): WholeTripItineraryContentTest, WholeTripDayUi, Modifier, modeLabel(), RouteLegContent(), RouteLegRow(), dayHeading(), Modifier (+2 more)

### Community 191 - "ItineraryRepository"
Cohesion: 0.25
...
### Community 197 - "RouteLegRepository"
Cohesion: 0.06
Nodes (21): Flow, Flow, Lifecycle, LifecycleOwner, TestOwner, Flow, Flow, Flow (+13 more)
...
### Community 210 - "Factory"
Cohesion: 0.50
Nodes (3): Factory, T, ViewModelProvider

### Community 212 - ".realNavigationEntersWorkspaceSearchesReturnsAndSwitchesSections"
Cohesion: 0.29
Nodes (3): CreateTrip, PlaceSearchDataSource, PlaceSearchDataSource

## Knowledge Gaps
- **722 isolated node(s):** `guard-adb-install.sh script`, `TRIP_LIST`, `CREATE_TRIP`, `DATE_PICKER`, `WORKSPACE` (+717 more)
...
- **Why does `GeoPoint` connect `GeoPoint` to `reduceMapInteraction`, `MapUiModelMapperTest`, `FakeRepository`, `PlacePoolUiState`, `PlaceSearchEvidenceTest`, `V1ScenarioExecutableFactory`, `RealAmapMapHost`, `TravelMode`, `.searchCollectionAndMapFlowUsesProductionNavigationState`, `AmapSmokeTest`, `RoutePlannerTest`, `PlaceCandidate`, `MapUiModel`, `AmapServiceException`, `MapFacade.kt`, `.Content`, `PlacePoolViewModel`, `FakeItineraries`, `PlaceSearchViewModel`, `TripWorkspaceViewModel`, `RouteLegRepository`, `TripWorkspaceNavigationStateTest`, `EditingPlaces`, `Legs`, `.realNavigationEntersWorkspaceSearchesReturnsAndSwitchesSections`, `AmapPlaceDataSource.kt`, `Legs`, `RoomRouteLegRepository`, `V1ScenarioExecutable.kt`, `ItineraryScope`, `AmapRouteDataSource.kt`, `decideCollectionToggle`, `DelayedDeletePlaces`, `AddPlacesToDayUseCase`, `RoomSavedPlaceRepositoryTest`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `TripDay` connect `TripDay` to `MapUiModelMapperTest`, `TripService`, `PlacePoolUiState`, `Trips`, `V1ScenarioExecutableFactory`, `TravelMode`, `Trips`, `Trips`, `TripRepository`, `Dp`, `PlaceCandidate`, `Legs`, `MapFacade.kt`, `FakeRepository`, `Trips`, `FakeTrips`, `FakeRepository`, `WholeTripItineraryContent`, `TripWorkspaceViewModel`, `RoomTripRepository`, `Trips`, `RouteLegRepository`, `TripWorkspaceNavigationStateTest`, `FakeTripRepository`, `RouteStatus`, `GeoPoint`, `ItineraryUiModels.kt`, `V1ScenarioExecutable.kt`, `ItineraryScope`, `Trips`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `TripRepository` connect `TripRepository` to `TripService`, `TripSettingsViewModel`, `Trips`, `TravelMode`, `Trips`, `TripListViewModel`, `Trips`, `DayDeletion`, `Legs`, `FakeRepository`, `Trips`, `FakeRepository`, `FakeTrips`, `FakeRepository`, `TripWorkspaceViewModel`, `RoomTripRepository`, `Trips`, `TestTripRepository`, `RouteLegRepository`, `TripWorkspaceNavigationStateTest`, `DateRangeDeletionCounts`, `FakeTripRepository`, `AppNavigation.kt`, `GeoPoint`, `Trips`?**
