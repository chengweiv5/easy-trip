...
## Corpus Check
- 257 files · ~129,684 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3457 nodes · 7285 edges · 168 communities (144 shown, 24 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 475 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `766c3c42`
...
Cohesion: 0.13
Nodes (12): DayDeleteImpact, DayUi, DeleteImpactProvider, Factory, androidx, StateFlow, T, ViewModel (+4 more)
...
Cohesion: 0.08
Nodes (7): RoomSavedPlaceRepositoryTest, IdFactory, T, MutableClock, RoomTripRepositoryTest, RoomTripRepository, CreateTrip
...
### Community 23 - "ItineraryScopeRail"
Cohesion: 0.23
...
Cohesion: 0.09
Nodes (13): Lifecycle, LifecycleOwner, TestOwner, Flow, InsertSide, AFTER, BEFORE, Flow (+5 more)
...
Cohesion: 0.06
Nodes (17): CascadeDeleteTest, Flow, ItineraryRepository, java, PlaceSearchDataSource, ItineraryRepository, PlaceSearchDataSource, PlaceSearchDataSource (+9 more)
...
Cohesion: 0.18
Nodes (12): AppNavigation(), AppNavigationDependencies, AppNavigationObserver, android, androidx, com, tripSearchRoute(), WorkspaceSearchReturnViewModel (+4 more)

### Community 42 - "View"
Cohesion: 0.05
Nodes (9): AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost (+1 more)

### Community 43 - "EasyTripPrimaryButton"
Cohesion: 0.16
...
Cohesion: 0.16
Nodes (21): AddPlace, AddPlaces, AppendTripDay, CommitMove, ConfirmDelete, DayItineraryAction, DayItineraryContent(), DayItinerarySheet() (+13 more)
...
Cohesion: 0.07
Nodes (9): AppIconResourceTest, RoomDeleteImpactProviderTest, Flow, PlaceDao, PlaceSnapshotRow, PlaceUsageRow, SavedPlaceTagCrossRef, TagEntity (+1 more)

### Community 48 - "AddToItineraryUiState"
Cohesion: 0.15
Nodes (16): ConfirmationUiModel, AddToItineraryUiState, ItineraryDeleteConfirmation, ItineraryEditDraft, Modifier, SelectTargetDayContent(), addOverlayToPresent(), canDismissAddOverlay() (+8 more)
...
Cohesion: 0.06
Nodes (23): Flow, Flow, GeoPoint, DayItinerary, ItineraryItem, ItineraryPlace, ItineraryRepository, Flow (+15 more)
...
Cohesion: 0.10
Nodes (8): TripDeleteImpact, CompletableDeferred, CreateTrip, Flow, TestImpacts, TestTripRepository, TripListViewModelTest, RuntimeException
...
### Community 78 - "Legs"
Cohesion: 0.06
Nodes (11): Itineraries, AmapMapHost, com, CreateTrip, ItineraryRepository, Legs, Places, PoiHost (+3 more)
...
### Community 110 - "Dp"
Cohesion: 0.13
Nodes (15): EasyTripIconButton(), Modifier, EmptyState(), Modifier, ItineraryItemCard(), ItineraryItemRow(), Color, Modifier (+7 more)
...
### Community 153 - "AddToItineraryStep"
Cohesion: 0.40
...
### Community 159 - "SavedPlace"
Cohesion: 0.13
Nodes (8): PlacePoolFlowTest, Flow, Flow, PlaceTag, SavedPlace, SavedPlaceRepository, PlaceDetailDraft, SavedPlaceRowUi
...
- **Why does `GeoPoint` connect `GeoPoint` to `Legs`, `MapUiModelMapperTest`, `MapFacade.kt`, `FakeRepository`, `FakeLegs`, `AmapComposeMap.kt`, `EditingPlaces`, `MapUiModel`, `RouteStatus`, `CreateTrip`, `TripWorkspaceScreen`, `RoutePlannerTest`, `TripDay`, `TripWorkspaceViewModel.kt`, `SavedPlace`, `AmapServiceException`, `PlaceCandidate`, `DelayedDeletePlaces`, `parsePlaces`, `PlacePoolViewModel`, `FakeSavedPlaces`, `TripWorkspaceViewModel`, `TripWorkspaceNavigationStateTest`, `decideCollectionToggle`, `Legs`, `AmapPlaceDataSource.kt`, `.Content`, `PlaceSearchReducer`, `reduceMapInteraction`, `PlaceSearchContentTest`, `MapViewportControllerTest`, `TravelMode`, `AmapRouteDataSource.kt`, `AmapSmokeTest`, `.searchCollectionMapAndRestorationFlow`, `RoomRouteLegRepository`, `AddPlacesRequest`, `TestSavedPlaces`?**
  _High betweenness centrality (0.154) - this node is a cross-community bridge._
- **Why does `TravelMode` connect `TravelMode` to `Legs`, `FakeTripRepository`, `Legs`, `TripSettingsViewModel`, `Trips`, `ItineraryTransactionTest`, `FakeLegs`, `Itineraries`, `RouteStatus`, `.setContent`, `TripDao`, `TripDay`, `Trips`, `SavedPlace`, `Legs`, `Context`, `FakeRepository`, `GeoPoint`, `CompactSecondaryButton`, `CreateTripViewModel`, `ItineraryItemEntity`, `TestTripRepository`, `TripWorkspaceNavigationStateTest`, `FakeTripRepository`, `CreateTripAction`, `Legs`, `CreateTripUiState`, `CreateTripContent`, `RoomItineraryRepository`, `RecordingTripRepository`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `RouteLegRepository` connect `GeoPoint` to `Legs`, `FakeRepository`, `Legs`, `Legs`, `AppNavigation.kt`, `FakeLegs`, `Legs`, `Itineraries`, `RouteStatus`, `Legs`, `Legs`, `TripDay`, `RoomRouteLegRepository`, `Trips`, `TripWorkspaceViewModel.kt`, `SavedPlace`?**
