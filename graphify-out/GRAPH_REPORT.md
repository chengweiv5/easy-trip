...
## Corpus Check
- 338 files · ~188,077 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5047 nodes · 10887 edges · 283 communities (233 shown, 50 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 779 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a0c1e30`
...
Cohesion: 0.17
Nodes (11): DayItinerary, ItineraryItem, ItineraryPlace, Flow, mapWholeTripDays(), toRouteErrorSummary(), toRouteLegUi(), WholeTripDayUi (+3 more)
...
Cohesion: 0.14
Nodes (17): PlacePoolFlowTest, CompactPrimaryButton(), CompactSecondaryButton(), AddToItineraryUiState, AddTripDayContent(), EditItineraryItemContent(), Modifier, Modifier (+9 more)
...
### Community 20 - "TripWorkspaceRoute.kt"
Cohesion: 0.07
Nodes (36): ConfirmationUiModel, CrossDayMoveDraft, ItineraryDeleteConfirmation, ItineraryEditDraft, RouteModeEditDraft, addOverlayToPresent(), AppendDayCompletionDecision, canDismissAddOverlay() (+28 more)
...
### Community 40 - "ItineraryItemEntity"
Cohesion: 0.15
Nodes (3): OfflineRecoveryTest, RoomRouteLegRepositoryTest, ItineraryItemEntity

### Community 41 - "TripSettingsViewModel"
Cohesion: 0.12
Nodes (10): TripSettingsRoute(), Factory, androidx, com, Job, StateFlow, T, ViewModel (+2 more)

### Community 42 - "WholeTripItineraryContent"
Cohesion: 0.20
Nodes (7): WholeTripItineraryContentTest, ItineraryEmptyIllustration(), Modifier, dayHeading(), Modifier, wholeTripDayColorIndex(), WholeTripItineraryContent()
...
Cohesion: 0.09
Nodes (24): TimeMode, DATED, DRAFT, TransportMode, DRIVE, TAXI, TRANSIT, WALK (+16 more)
...
### Community 53 - "WorkspaceFlowTest.kt"
Cohesion: 0.06
Nodes (19): Flow, Flow, Lifecycle, LifecycleOwner, TestOwner, Flow, Flow, ItineraryRepository (+11 more)
...
### Community 57 - "WorkspaceNavigationTest"
Cohesion: 0.23
...
Cohesion: 0.09
Nodes (11): GeoPoint, SavedPlace, Result, PolylineCodec, ControlledSearchSource, FakeSavedPlaces, IgnoringCancellationSearchSource, ImmediateSearchSource (+3 more)
...
### Community 71 - "AppNavigation"
Cohesion: 0.12
Nodes (13): AppNavigationObserver, AppNavigationObserver, AppNavigation(), AppNavigationDependencies, AppNavigationObserver, android, com, DeleteImpactProvider (+5 more)
...
### Community 74 - ".onAction"
Cohesion: 0.17
Nodes (4): AwaitingDeletedTrip, OpenSettings, OpenWorkspace, TripListNavigation
...
Cohesion: 0.07
Nodes (10): AppIconResourceTest, V1AcceptanceTest, AmapPrivacyGate, Flow, RoomSavedPlaceRepository, AlreadySaved, PlaceTag, Saved (+2 more)
...
Cohesion: 0.12
Nodes (7): com, PlaceSearchDataSource, com, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, PlacePoolSheet()
...
Cohesion: 0.05
Nodes (25): BlockingRepository, CompletingRepository, CreateTripRouteTest, com, CreateTrip, ClearedProbe, ViewModel, WorkspaceSearchReturnNavEntryTest (+17 more)
...
Cohesion: 0.12
Nodes (13): WorkspacePlacePoolLayoutTest, androidx, com, TripWorkspaceContentTest, DayItineraryUiState, PlacePoolUiState, Composable, Modifier (+5 more)
...
Cohesion: 0.05
Nodes (37): AmapMapViewAttachSmokeTest, AmapAttachSmokeActivity, Bundle, ComponentActivity, AmapConsentToken, AmapPrivacyStateMachine, ConsentRegistry, ConsentSnapshot (+29 more)
...
### Community 160 - "MapViewportRequest"
Cohesion: 0.13
...
Cohesion: 0.10
Nodes (12): AmapPlaceDataSource, CallbackBoundary, PoiSearch, CallbackBoundary, com, parsePoiSearchResponse(), PlaceSearchDataSource, parsePlaces() (+4 more)
...
### Community 182 - "DayDeleteImpact"
Cohesion: 0.20
Nodes (4): DayDeleteImpact, DeleteImpactProvider, FakeImpacts, DeleteImpactProvider

### Community 183 - "Flow"
Cohesion: 0.11
Nodes (3): DelayedDeleteRepository, DelayedUpdateRepository, Flow
...
Cohesion: 0.14
Nodes (16): TripSettingsContentTest, AddToItineraryStep, COMPLETED, IDLE, SELECT_PLACES, SELECT_TARGET_DAY, Empty, Initial (+8 more)
...
### Community 218 - "TripListViewModel.kt"
Cohesion: 0.25
Nodes (7): Factory, CreationExtras, Job, StateFlow, T, ViewModel, ViewModelProvider

### Community 219 - "LocationPermissionCoordinator"
Cohesion: 0.11
Nodes (9): Itineraries, ItineraryRepository, Places, Trips, WorkspaceFlowTest, LocationPermissionCoordinator, LocationPermissionSnapshot, TripWorkspaceRoute() (+1 more)
...
Cohesion: 0.07
Nodes (15): Flow, Flow, Flow, Flow, InsertSide, AFTER, BEFORE, Flow (+7 more)
...
### Community 256 - "MapLayerFlowTest"
Cohesion: 0.38
...
### Community 267 - "RoomTripRepository"
Cohesion: 0.14
...
### Community 274 - "TripDeletionUiState"
Cohesion: 0.40
Nodes (5): Idle, ImpactFailure, LoadingImpact, Ready, TripDeletionUiState

### Community 275 - "EmptyState"
Cohesion: 0.83
Nodes (3): EmptyState(), Composable, Modifier
...
## Knowledge Gaps
- **1101 isolated node(s):** `guard-adb-install.sh script`, `TRIP_LIST`, `CREATE_TRIP`, `DATE_PICKER`, `WORKSPACE` (+1096 more)
...
- **Why does `GeoPoint` connect `GeoPoint` to `MapUiModelMapperTest`, `FakeRepository`, `DayItineraryUiState`, `DayItinerary`, `V1ScenarioExecutableFactory`, `PlaceSearchReducer`, `RouteStatus`, `CompactSecondaryButton`, `AmapMapHost`, `Legs`, `PolylineCodecTest`, `reduceMapInteraction`, `AmapServiceException`, `SavedPlaceRepository`, `DayItinerarySelectionTest.kt`, `MapViewportRequest`, `.searchCollectionAndMapFlowUsesProductionNavigationState`, `MapUiModel`, `DelayedDeletePlaces`, `ItineraryItemEntity`, `AmapPlaceDataSource.kt`, `decideCollectionToggle`, `DayItineraryContent`, `TravelMode`, `.realNavigationEntersWorkspaceSearchesReturnsAndSwitchesSections`, `AmapRouteDataSource`, `TripWorkspaceViewModel`, `WorkspaceFlowTest.kt`, `FakeTrips`, `V1ScenarioExecutable.kt`, `.setContent`, `RoutePlannerTest`, `RoomRouteLegRepository`, `RoomSavedPlaceRepository`, `RealAmapMapHost`, `AmapRouteDataSource.kt`, `MapFacade.kt`, `LocationPermissionCoordinator`, `PlaceCandidate`, `RoomSavedPlaceRepositoryTest`, `Legs`, `.referencedSavedResultRequiresConfirmationAndDismissPreservesData`, `TripWorkspaceNavigationStateTest`, `PlaceDeletionImpact`, `PlacePoolViewModelTest`, `AddPlacesToDayUseCase`, `MapViewportControllerTest`, `MapViewportRenderingPolicyTest`, `.Content`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `TripRepository` connect `TripDay` to `FakeTripRepository`, `DayItinerary`, `Trips`, `RoomTripRepository`, `TripListViewModel`, `Trips`, `DayItineraryViewModelTest`, `Legs`, `CreateTrip`, `DateRangeApply`, `DayItinerarySelectionTest.kt`, `FakeRepository`, `TripSettingsViewModel`, `TravelMode`, `.realNavigationEntersWorkspaceSearchesReturnsAndSwitchesSections`, `TripWorkspaceViewModel`, `WorkspaceFlowTest.kt`, `FakeRepository`, `FakeTrips`, `FakeRepository`, `RecordingTripRepository`, `AppNavigation`, `FakeTripRepository`, `DateRangeDeletionCounts`, `TripListViewModel.kt`, `LocationPermissionCoordinator`, `BlockingRepository`, `TripWorkspaceNavigationStateTest`, `Legs`, `DayDeletion`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `SavedPlace` connect `GeoPoint` to `MapUiModelMapperTest`, `Flow`, `DayItineraryUiState`, `DayItinerary`, `Trips`, `V1ScenarioExecutableFactory`, `PlaceSearchReducer`, `RouteStatus`, `CompactSecondaryButton`, `Legs`, `SavedPlaceRepository`, `PlaceSearchViewModel`, `DelayedDeletePlaces`, `DelayedRepository`, `AmapPlaceDataSource.kt`, `TestSavedPlaces`, `DayItineraryContent`, `decideCollectionToggle`, `TripWorkspaceViewModel`, `WorkspaceFlowTest.kt`, `PlacePoolViewModel`, `FakeTrips`, `Flow`, `V1ScenarioExecutable.kt`, `.setContent`, `RoomSavedPlaceRepository`, `DelayedRowsRepository`, `MapFacade.kt`, `LocationPermissionCoordinator`, `.referencedSavedResultRequiresConfirmationAndDismissPreservesData`, `PlaceDeletionImpact`, `SelectablePill`, `PlacePoolViewModelTest`, `.Content`?**
