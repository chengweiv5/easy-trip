# Graph Report - itinerary-ui-convergence  (2026-08-26)

## Corpus Check
- 299 files · ~158,167 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4198 nodes · 8957 edges · 237 communities (187 shown, 50 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 609 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `998cc079`
...
1. `GeoPoint` - 148 edges
2. `PlaceCandidate` - 95 edges
3. `TripDay` - 83 edges
4. `SavedPlace` - 76 edges
5. `TravelMode` - 72 edges
6. `TripWorkspaceViewModel` - 61 edges
7. `TransportMode` - 58 edges
8. `CreateTrip` - 58 edges
9. `TripService` - 56 edges
10. `TripRepository` - 50 edges
...
Cohesion: 0.05
Nodes (32): Flow, Flow, connected(), hasValidatedInternet(), StateFlow, NetworkMonitor, onAvailable(), onCapabilitiesChanged() (+24 more)
...
### Community 7 - "PlaceSearchReducer"
Cohesion: 0.17
...
Cohesion: 0.06
Nodes (12): TripWithDays, Itineraries, com, CreateTrip, Flow, ItineraryRepository, Trips, Legs (+4 more)

### Community 9 - "V1ScenarioExecutableFactory"
Cohesion: 0.15
Nodes (9): ComposeScenario, com, ScenarioFixture, ScenarioPath, V1ScenarioExecutable, V1ScenarioExecutableFactory, ItineraryItemUi, RouteLegUi (+1 more)
...
### Community 26 - "TripListViewModel.kt"
Cohesion: 0.14
Nodes (10): Factory, CreationExtras, Job, StateFlow, T, ViewModel, ViewModelProvider, OpenSettings (+2 more)
...
### Community 43 - "EasyTripDatabase"
Cohesion: 0.07
Nodes (15): OfflineRecoveryTest, RoomRouteLegRepositoryTest, RoomDeleteImpactProviderTest, EasyTripDatabase, com, SchemaPlaceDao, SchemaRouteDao, ItineraryItemEntity (+7 more)
...
### Community 46 - "TripDay"
Cohesion: 0.14
Nodes (11): DaySelector(), TripDay, Day, decodeItineraryScope(), encodeItineraryScope(), ItineraryScope, reconcileItineraryScope(), RestoredWorkspaceNavigation (+3 more)
...
### Community 50 - "TripWorkspaceNavigationStateTest.kt"
Cohesion: 0.21
Nodes (12): ConfirmationUiModel, CrossDayMoveDraft, ItineraryDeleteConfirmation, ItineraryEditDraft, RouteModeEditDraft, addOverlayToPresent(), canDismissAddOverlay(), canDismissWorkspaceOverlay() (+4 more)
...
Cohesion: 0.19
Nodes (3): kotlinx, PlaceSearchDataSource, PlacePoolViewModel
...
### Community 57 - "SavedPlace"
Cohesion: 0.10
Nodes (28): PlacePoolFlowTest, CompactDangerButton(), CompactPrimaryButton(), CompactSecondaryButton(), Modifier, AddToItineraryUiState, AddTripDayContent(), EditItineraryItemContent() (+20 more)

### Community 58 - "WorkspaceItineraryContent"
Cohesion: 0.21
...
Cohesion: 0.11
Nodes (10): TripSummary, TripListViewModel, TripListUiModelsTest, com, CompletableDeferred, CreateTrip, Flow, TestImpacts (+2 more)

### Community 69 - "WholeTripItineraryContent"
Cohesion: 0.23
Nodes (5): WholeTripItineraryContentTest, dayHeading(), Modifier, wholeTripDayColorIndex(), WholeTripItineraryContent()
...
### Community 76 - "SelectablePill"
Cohesion: 0.15
Nodes (11): SelectablePillTest, LazyListState, Modifier, PlacePoolScrollbarTest, Modifier, Role, SelectablePill(), SelectablePillStyle (+3 more)
...
Cohesion: 0.16
Nodes (5): Itineraries, ItineraryRepository, PoiHost, WorkspaceFlowTest, MapPoiUi
...
Cohesion: 0.16
Nodes (12): AppNavigation(), consumeWorkspaceSearchReturn(), android, androidx, com, publishWorkspaceSearchReturn(), tripSearchRoute(), WorkspaceSearchReturnViewModel (+4 more)
...
### Community 93 - "SearchMapFocusTest"
Cohesion: 0.50
...
Cohesion: 0.15
Nodes (8): AddPlacesRoomIntegrationTest, DeleteTargetDayAfterFirstAddRepository, ItineraryRepository, SequenceIds, UndoAddedItemsOutcome, UndoAddedItemsRequest, UndoAddedItemsUseCase, UndoAddedItemsUseCaseTest
...
Cohesion: 0.09
Nodes (24): ItineraryTimelineContentTest, ItineraryItemMenu(), ItineraryItemMenuAction, Delete, EditTiming, MoveToOtherDay, Modifier, MenuItem() (+16 more)

### Community 98 - "EasyTripPrimaryButton"
Cohesion: 0.25
Nodes (11): EasyTripButtonTest, CompactActionButton(), EasyTripButton(), EasyTripButtonStyle, DANGER, PRIMARY, SECONDARY, EasyTripDangerButton() (+3 more)
...
### Community 109 - "AmapPrivacyStateMachine"
Cohesion: 0.18
Nodes (3): AmapMapViewAttachSmokeTest, AmapPrivacyStateMachine, AmapPrivacyStateMachineTest
...
### Community 112 - "TravelMode"
Cohesion: 0.12
Nodes (8): TravelMode, FLEXIBLE, SELF_DRIVE, defaultRecommendMode(), haversineMeters(), Flow, TransportModeRecommender, RoomDatabase

### Community 113 - "PlaceSearchState"
Cohesion: 0.31
...
### Community 119 - "TripWorkspaceRoute"
Cohesion: 0.10
Nodes (4): DelayedDeletePlaces, Places, stableWorkspaceOverlayId(), TripWorkspaceRoute()
...
### Community 130 - "TripService"
Cohesion: 0.15
Nodes (3): com, CreateTrip, TripService

### Community 132 - "DayItineraryUiState"
Cohesion: 0.09
Nodes (26): WorkspacePlacePoolLayoutTest, WorkspaceSheetScenarioSpec, androidx, com, TripWorkspaceContentTest, DayItineraryUiState, PlacePoolUiState, Composable (+18 more)
...
### Community 157 - "WorkspacePermissionFlowTest"
Cohesion: 0.25
...
### Community 160 - "TripWorkspaceNavigationStateTest"
Cohesion: 0.13
Nodes (5): CreateTrip, SavedStateHandle, Trips, Trips, TripWorkspaceNavigationStateTest

### Community 161 - "PlaceCandidate"
Cohesion: 0.14
Nodes (9): V1AcceptanceTest, PlaceCandidate, AlreadySaved, Flow, PlaceTag, Saved, SavedPlaceRepository, SavePlaceResult (+1 more)
...
Cohesion: 0.13
Nodes (7): PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, Flow, RoomSavedPlaceRepository, PlacePoolSheet()

### Community 172 - "GeoPoint"
Cohesion: 0.09
Nodes (8): Places, GeoPoint, parsePlaces(), RawPlace, Result, PolylineCodec, PlaceContractsTest, PolylineCodecTest
...
### Community 189 - "ItineraryUiModels.kt"
Cohesion: 0.21
Nodes (12): Calculating, Failed, mapWholeTripDays(), Ready, RouteLegUiState, toItineraryItemUi(), toRouteErrorSummary(), toRouteLegUi() (+4 more)

### Community 191 - "Task 3 报告：排序仅由拖动手柄发起"
Cohesion: 0.25
Nodes (7): Fix round 1, Task 3 报告：排序仅由拖动手柄发起, TDD 证据, 关注点, 实现, 状态, 验证

### Community 192 - "LocationPermissionCoordinator.kt"
Cohesion: 0.16
Nodes (12): StateFlow, LocationPermissionRequestStore, OpenApplicationSettings, RequestLocationPermission, SavedStateLocationPermissionRequestStore, SharedPreferencesLocationPermissionRequestStore, ShowCurrentLocation, WorkspaceEffect (+4 more)

### Community 196 - "Task 6 报告"
Cohesion: 0.22
Nodes (8): GREEN 与完整回归, RED, SHA, Task 6 报告, 修改文件, 关注点, 状态, 自审

### Community 198 - "DayDeleteImpact"
Cohesion: 0.20
Nodes (3): DayDeleteImpact, TripDeleteImpact, FakeImpacts

### Community 199 - "TripListAction"
Cohesion: 0.15
Nodes (12): Content, CreateTrip, Empty, Error, Loading, OpenSettings, OpenTrip, RequestDelete (+4 more)

### Community 200 - "MapUiModel"
Cohesion: 0.08
Nodes (12): AmapComposeMapTest, AmapMapHost, AmapMapHost, AmapMapHost, Lifecycle, LifecycleOwner, TestOwner, MapMarkerKind (+4 more)

### Community 201 - "MapFacade.kt"
Cohesion: 0.13
Nodes (14): formatOccurrenceBadge(), MapMarkerUi, MapPolylineUi, MapRouteLabelUi, MapScope, PLACE_POOL, SINGLE_DAY, WHOLE_TRIP (+6 more)

### Community 202 - "decideCollectionToggle"
Cohesion: 0.24
...
### Community 217 - "PlacePoolViewModel.kt"
Cohesion: 0.25
Nodes (6): Factory, Job, StateFlow, T, ViewModel, ViewModelProvider

### Community 219 - "MapLayerFlowTest"
Cohesion: 0.38
...
### Community 222 - "AddToItineraryStep"
Cohesion: 0.40
...
## Knowledge Gaps
- **812 isolated node(s):** `guard-adb-install.sh script`, `TRIP_LIST`, `CREATE_TRIP`, `DATE_PICKER`, `WORKSPACE` (+807 more)
...
- **Why does `GeoPoint` connect `GeoPoint` to `MapUiModelMapperTest`, `RouteLegRepository`, `DayItineraryUiState`, `PlaceSearchReducer`, `V1ScenarioExecutableFactory`, `RealAmapMapHost`, `CreateTrip`, `RoutePlannerTest`, `TestSavedPlaces`, `TripWorkspaceNavigationStateTest`, `PlaceCandidate`, `AmapComposeMap`, `Itineraries`, `AmapServiceException`, `EasyTripDatabase`, `RoomSavedPlaceRepository`, `PlacePoolViewModelTest`, `TripWorkspaceNavigationStateTest.kt`, `FakeTrips`, `.mapDetailBackThenPlaceEditRendersNewTarget`, `SavedPlace`, `ItineraryUiModels.kt`, `PlaceSearchViewModel`, `TripWorkspaceViewModel`, `AmapSmokeTest`, `MapUiModel`, `DayItinerary`, `MapFacade.kt`, `decideCollectionToggle`, `SelectablePill`, `WorkspaceFlowTest`, `AmapRouteDataSource`, `RecordingHost`, `AmapPlaceDataSource.kt`, `reduceMapInteraction`, `WorkspaceFlowTest.kt`, `SearchMapFocusTest`, `V1ScenarioExecutable.kt`, `MapViewportControllerTest`, `AmapRouteDataSource.kt`, `TravelMode`, `PlaceSearchState`, `TripWorkspaceRoute`, `AddPlacesRequest`, `RoomItineraryRepository`, `MapView`?**
  _High betweenness centrality (0.146) - this node is a cross-community bridge._
- **Why does `TripDay` connect `TripDay` to `MapUiModelMapperTest`, `TripService`, `FakeTripRepository`, `DayItineraryUiState`, `TripWithDays`, `V1ScenarioExecutableFactory`, `DayItineraryViewModel`, `Trips`, `DayItineraryViewModelTest`, `FakeRepository`, `CreateTrip`, `LongNameTrips`, `Trips`, `TripWorkspaceNavigationStateTest`, `PlaceCandidate`, `Legs`, `TripWorkspaceNavigationStateTest.kt`, `FakeTrips`, `SavedPlace`, `WorkspaceItineraryContent`, `FakeRepository`, `ItineraryUiModels.kt`, `TripWorkspaceViewModel`, `WholeTripItineraryContent`, `MapFacade.kt`, `DayItinerary`, `FakeTripRepository`, `Trips`, `WorkspaceFlowTest.kt`, `V1ScenarioExecutable.kt`, `Trips`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `PlaceCandidate` connect `PlaceCandidate` to `MapUiModelMapperTest`, `PlaceSearchReducer`, `TripWithDays`, `V1ScenarioExecutableFactory`, `CreateTrip`, `TestSavedPlaces`, `Places`, `Legs`, `EasyTripDatabase`, `RoomSavedPlaceRepository`, `GeoPoint`, `PlacePoolViewModelTest`, `SavedPlaces`, `TripWorkspaceNavigationStateTest.kt`, `PlacePoolViewModel`, `.mapDetailBackThenPlaceEditRendersNewTarget`, `SavedPlace`, `PlaceSearchViewModel`, `TripWorkspaceViewModel`, `DelayedRowsRepository`, `PlaceSearchContent.kt`, `MapFacade.kt`, `decideCollectionToggle`, `RecordingHost`, `AmapPlaceDataSource.kt`, `reduceMapInteraction`, `PlacePoolViewModel.kt`, `WorkspaceFlowTest.kt`, `PoolRepository`, `V1ScenarioExecutable.kt`, `Places`, `PlaceSearchState`, `PlacePoolContent`, `TripWorkspaceRoute`, `RoomItineraryRepository`, `AppContainer.kt`?**
