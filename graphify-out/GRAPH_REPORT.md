...
## Corpus Check
- 309 files · ~165,860 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4394 nodes · 9306 edges · 242 communities (201 shown, 41 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 638 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `01d87fed`
...
1. `GeoPoint` - 151 edges
2. `PlaceCandidate` - 97 edges
3. `TripDay` - 89 edges
4. `SavedPlace` - 79 edges
...
### Community 7 - "TripWorkspaceRoute.kt"
Cohesion: 0.30
...
### Community 10 - "PlaceSearchEvidenceTest"
Cohesion: 0.05
...
Cohesion: 0.10
Nodes (13): TransportMode, DRIVE, TAXI, TRANSIT, WALK, TravelMode, FLEXIBLE, SELF_DRIVE (+5 more)
...
Cohesion: 0.14
Nodes (11): consumeWorkspaceSearchReturn(), publishWorkspaceSearchReturn(), shouldConsumeSearchReturn(), WorkspaceSection, ITINERARY, PLACE_POOL, Modifier, WorkspaceTabs() (+3 more)
...
Cohesion: 0.07
Nodes (21): Flow, Flow, Flow, Flow, PlaceCandidate, PlaceSearchDataSource, AlreadySaved, PlaceTag (+13 more)
...
Cohesion: 0.05
Nodes (34): PendingCollectionRemoval, Back, CancelEdit, ConfirmRemoval, decidePlaceSearchBack(), DismissRemovalConfirmation, ExitDestination, Factory (+26 more)

### Community 63 - "TripWorkspaceViewModel"
Cohesion: 0.10
Nodes (11): TripWorkspaceScreen(), Factory, CreationExtras, java, Job, StateFlow, T, ViewModel (+3 more)
...
Cohesion: 0.13
Nodes (6): Itineraries, ItineraryRepository, Places, PoiHost, WorkspaceFlowTest, MapPoiUi
...
Cohesion: 0.14
Nodes (16): PlaceSearchDataSource, PlaceSearchDataSource, AppNavigation(), AppNavigationDependencies, AppNavigationObserver, android, androidx, com (+8 more)
...
### Community 88 - "Legs"
Cohesion: 0.06
Nodes (9): Itineraries, ItineraryRepository, Lifecycle, LifecycleOwner, Legs, Places, SavedPlaces, SearchMapFocusTest (+1 more)

### Community 89 - "V1AcceptanceTest.kt"
Cohesion: 0.22
Nodes (6): V1AcceptanceTest, mapWholeTripDays(), toRouteErrorSummary(), toRouteLegUi(), DayMapSnapshot, WholeTripItineraryMapperTest

### Community 91 - "MapLayer"
Cohesion: 0.10
Nodes (8): AmapMapHost, AmapMapHost, RecordingHost, MapLayer, SATELLITE_ROAD, STANDARD, FailingMapPreferences, StateFlow

### Community 93 - "TestSavedPlaces"
Cohesion: 0.14
...
### Community 108 - "PermissionExplanationContent"
Cohesion: 0.18
...
### Community 113 - "CallbackBoundary"
Cohesion: 0.12
...
### Community 123 - "LocationPermissionCoordinator.kt"
Cohesion: 0.27
...
Cohesion: 0.12
Nodes (11): LazyListState, Modifier, PlacePoolScrollbarTest, SavedPlace, CollectionDecision, Confirm, decideCollectionToggle(), RemoveNow (+3 more)

### Community 132 - "DayItineraryUiState"
Cohesion: 0.13
Nodes (6): androidx, com, TripWorkspaceContentTest, DayItineraryUiState, PlacePoolUiState, TripWorkspaceUiState
...
### Community 144 - ".realNavigationEntersWorkspaceSearchesReturnsAndSwitchesSections"
Cohesion: 0.19
Nodes (6): CreateTrip, PlaceSearchDataSource, PlaceSearchDataSource, InMemoryMapPreferences, StateFlow, MapPreferences

### Community 146 - "RoomSavedPlaceRepository"
Cohesion: 0.08
Nodes (11): CascadeDeleteTest, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, AppContainer, CoroutineScope, Flow (+3 more)

### Community 147 - "RoutePlannerTest"
Cohesion: 0.38
Nodes (3): RouteDataSource, RoutePlannerTest, RouteDataSource

### Community 148 - "calculateScrollbarThumb"
Cohesion: 0.29
...
### Community 178 - "EasyTripDatabase"
Cohesion: 0.07
...
Cohesion: 0.11
Nodes (11): Flow, GeoPoint, DayItinerary, ItineraryItem, ItineraryPlace, ItineraryRepository, Flow, Result (+3 more)

### Community 185 - "FailingMapHost"
Cohesion: 0.15
Nodes (3): FailingMapHost, AmapMapHost, TestMapHost

### Community 186 - "SavedPlaceEntity"
Cohesion: 0.13
Nodes (9): OfflineRecoveryTest, RoomDeleteImpactProviderTest, ItineraryItemEntity, SavedPlaceEntity, CreateTrip, TripDayEntity, TripEntity, Clock (+1 more)
...
### Community 205 - "AddToItineraryStep"
Cohesion: 0.40
...
## Knowledge Gaps
- **927 isolated node(s):** `guard-adb-install.sh script`, `TRIP_LIST`, `CREATE_TRIP`, `DATE_PICKER`, `WORKSPACE` (+922 more)
...
- **Why does `GeoPoint` connect `GeoPoint` to `TripWorkspaceNavigationStateTest`, `MapUiModelMapperTest`, `SavedPlace`, `FakeRepository`, `DayItineraryUiState`, `V1ScenarioExecutableFactory`, `PlaceSearchEvidenceTest`, `RouteStatus`, `TravelMode`, `V1ScenarioExecutable.kt`, `.realNavigationEntersWorkspaceSearchesReturnsAndSwitchesSections`, `RoomSavedPlaceRepository`, `CreateTrip`, `RouteLegRepository`, `RoutePlannerTest`, `LocationPermissionCoordinator`, `AmapComposeMap`, `AmapComposeMapTest.kt`, `AmapServiceException`, `SavedPlaceRepository`, `reduceMapInteraction`, `PlaceCandidate`, `EasyTripDatabase`, `PlacePoolViewModel`, `FakeTrips`, `SavedPlaceRowUi`, `SavedPlaceEntity`, `PlaceSearchViewModel`, `TripWorkspaceViewModel`, `AmapSmokeTest`, `MapUiModel`, `WorkspaceFlowTest`, `MapViewportRenderingPolicyTest`, `AppNavigation.kt`, `AmapPlaceDataSource.kt`, `parsePlaces`, `Legs`, `V1AcceptanceTest.kt`, `RoomRouteLegRepository`, `TestSavedPlaces`, `MapViewportControllerTest`, `AmapRouteDataSource.kt`, `TripWorkspaceContent`, `DelayedDeletePlaces`, `AddPlacesRequest`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `TripRepository` connect `TripRepository` to `TripWorkspaceNavigationStateTest`, `FakeTripRepository`, `TripSettingsViewModel`, `Trips`, `Trips`, `DayItineraryViewModelTest`, `CreateTrip`, `RouteLegRepository`, `LocationPermissionCoordinator`, `Trips`, `FakeRepository`, `InsertSide`, `Legs`, `PlaceCandidate`, `LongNameTrips`, `FakeRepository`, `FakeTrips`, `DateRangeDeletionCounts`, `GeoPoint`, `FakeRepository`, `TripListViewModel`, `TripSummary`, `RecordingTripRepository`, `FakeTripRepository`, `AppNavigation.kt`, `Trips`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `MapLayer` connect `MapLayer` to `AmapMapHost`, `MemoryPreferences`, `AmapComposeMap`, `AmapComposeMapTest.kt`, `MapLayerRenderingPolicyTest`, `MapUiModel`, `View`, `TestMapHost`, `RealAmapMapHost`, `MapControls`, `WorkspaceFlowTest`, `V1ScenarioExecutable.kt`, `.realNavigationEntersWorkspaceSearchesReturnsAndSwitchesSections`, `AmapMapHost`, `EasyTripDatabase`, `MapLayerFlowTest`, `RecordingHost`, `FailingMapHost`?**
