...
## Summary
- 4348 nodes · 9208 edges · 244 communities (198 shown, 46 thin omitted)
...
- `PlaceSearchViewModel` --calls--> `PlaceSearchReducer`  [INFERRED]
  app/src/main/java/com/yangchengwei/easytrip/place/ui/PlaceSearchViewModel.kt → app/src/main/java/com/yangchengwei/easytrip/place/ui/PlaceSearchReducer.kt
...
## Communities (244 total, 46 thin omitted)
...
### Community 7 - "AddToItineraryUiState"
Cohesion: 0.15
...
Cohesion: 0.09
Nodes (15): OfflineRecoveryTest, TransportMode, DRIVE, TAXI, TRANSIT, WALK, ItineraryItemEntity, defaultRecommendMode() (+7 more)
...
Cohesion: 0.07
Nodes (10): IdFactory, T, MutableClock, RoomTripRepositoryTest, TripDateRangeRoomTest, V1PencilFlowTest, CreateTrip, RoomTripRepository (+2 more)
...
### Community 20 - "PlacePoolViewModel"
Cohesion: 0.12
...
Cohesion: 0.06
Nodes (20): Flow, Flow, Flow, Flow, ItineraryRepository, AlreadySaved, Flow, PlaceTag (+12 more)
...
Cohesion: 0.27
Nodes (5): Modifier, SelectPlacesContent(), SavedPlace, EditSavedPlaceDialog(), SavedPlaceRowUi
...
### Community 67 - "PlaceSearchViewModel"
Cohesion: 0.13
...
Cohesion: 0.09
Nodes (10): Flow, InsertSide, AFTER, BEFORE, Flow, TripDay, TripRepository, TripWithDays (+2 more)

### Community 74 - "TravelMode"
Cohesion: 0.08
Nodes (7): com, CreateTrip, Flow, RecordingTripRepository, TravelMode, FLEXIBLE, SELF_DRIVE
...
### Community 78 - "Legs"
Cohesion: 0.08
Nodes (10): Itineraries, ItineraryRepository, Legs, Places, PoiHost, Trips, WorkspaceFlowTest, MapPoiUi (+2 more)
...
Cohesion: 0.12
Nodes (17): PlaceSearchDataSource, PlaceSearchDataSource, AppNavigation(), AppNavigationDependencies, AppNavigationObserver, consumeWorkspaceSearchReturn(), android, androidx (+9 more)
...
Cohesion: 0.08
Nodes (10): com, Flow, com, com, TestSavedPlaces, GeoPoint, PlaceCandidate, Result (+2 more)
...
Cohesion: 0.19
Nodes (7): AmapMapViewAttachSmokeTest, AmapSmokeTest, AmapAttachSmokeActivity, Bundle, ComponentActivity, FrameLayout, MapView

### Community 99 - "AmapConsentToken"
Cohesion: 0.10
Nodes (12): AmapConsentToken, AmapPrivacyGate, AmapPrivacyStateMachine, ConsentRegistry, ConsentSnapshot, StateFlow, TestConsentGate, AppContainer (+4 more)
...
Cohesion: 0.14
Nodes (12): CreateTrip, PlaceSearchDataSource, PlaceSearchDataSource, InMemoryLocationPermissionRequestStore, StateFlow, LocationPermissionRequestStore, OpenApplicationSettings, RequestLocationPermission (+4 more)
...
Cohesion: 0.15
Nodes (3): RoomSavedPlaceRepositoryTest, Flow, RoomSavedPlaceRepository
...
### Community 177 - "PlacePoolFlowTest"
Cohesion: 0.09
Nodes (9): Flow, ItineraryRepository, java, PlaceSearchDataSource, PlacePoolFlowTest, ItineraryRepository, PlaceSearchDataSource, PlaceSearchDataSource (+1 more)
...
Cohesion: 0.23
Nodes (7): DayItinerary, ItineraryItem, ItineraryPlace, Flow, mapWholeTripDays(), DayMapSnapshot, WholeTripItineraryMapperTest
...
Cohesion: 0.10
Nodes (19): formatOccurrenceBadge(), MapMarkerUi, MapPolylineUi, MapRouteLabelUi, MapScope, PLACE_POOL, SINGLE_DAY, WHOLE_TRIP (+11 more)
...
### Community 213 - "V2AcceptanceTest.kt"
Cohesion: 0.18
...
## Knowledge Gaps
- **908 isolated node(s):** `1. 目标`, `2.1 搜索结果`, `2.2 搜索地图详情模式`, `2.3 地点池行操作`, `2.4 地点详情` (+903 more)
...
- **What connects `1. 目标`, `2.1 搜索结果`, `2.2 搜索地图详情模式` to the rest of the system?**
