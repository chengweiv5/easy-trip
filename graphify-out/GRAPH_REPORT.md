...
## Corpus Check
- 276 files · ~142,532 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3819 nodes · 8411 edges · 195 communities (161 shown, 34 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 551 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d736a2a3`
...
## Communities (195 total, 34 thin omitted)
...
Cohesion: 0.23
Nodes (6): ComposeScenario, ScenarioFixture, ScenarioPath, V1ScenarioExecutable, V1ScenarioExecutableFactory, ItineraryItemUi
...
### Community 14 - "TripDay"
Cohesion: 0.06
Nodes (26): Flow, Flow, Flow, Flow, Flow, ItineraryRepository, AlreadySaved, PlaceTag (+18 more)
...
### Community 20 - "SavedPlaceEntity"
Cohesion: 0.08
Nodes (10): SchemaPlaceDao, defaultRecommendMode(), haversineMeters(), Flow, PlaceDao, PlaceSnapshotRow, PlaceUsageRow, SavedPlaceEntity (+2 more)
...
Cohesion: 0.07
Nodes (9): com, CreateTrip, Flow, RecordingTripRepository, TravelMode, FLEXIBLE, SELF_DRIVE, TransportModeRecommender (+1 more)
...
Cohesion: 0.04
Nodes (20): AmapComposeMapTest, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost, AmapMapHost (+12 more)
...
### Community 47 - "PlaceSearchContent.kt"
Cohesion: 0.33
...
### Community 53 - "RouteLegUi"
Cohesion: 0.27
Nodes (9): Failed, Ready, RouteLegUi, RouteLegUiState, WaitingForNetwork, Modifier, modeLabel(), RouteLegContent() (+1 more)
...
Cohesion: 0.16
Nodes (10): ItineraryScopeRailTest, ItineraryScopeRail(), Modifier, ScopeItem(), dayHeading(), Modifier, wholeTripDayColorIndex(), WholeTripItineraryContent() (+2 more)

### Community 74 - "ItineraryEditDraft"
Cohesion: 0.35
...
Cohesion: 0.14
Nodes (4): Itineraries, ItineraryRepository, Places, WorkspaceFlowTest
...
### Community 83 - "TripListContent.kt"
Cohesion: 0.32
...
### Community 90 - "PlacePoolViewModel"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (7): CascadeDeleteTest, CascadeCountDao, EasyTripDatabase, com, SchemaItineraryDao, SchemaRouteDao, RoomDatabase

### Community 93 - ".workspaceScenario"
Cohesion: 0.13
Nodes (13): com, Modifier, WorkspaceMapFallback(), ConsentRequired, Error, Failed, Loading, NotFound (+5 more)
...
### Community 97 - "WorkspaceSearchReturn"
Cohesion: 0.26
...
### Community 119 - "DayItineraryUiState"
Cohesion: 0.25
Nodes (11): WorkspaceSheetScenarioSpec, DayItineraryUiState, PlacePoolUiState, Composable, Modifier, TripWorkspaceContent(), WorkspacePageMessage(), WorkspaceReadyContent() (+3 more)
...
### Community 125 - "SavedPlace"
Cohesion: 0.30
Nodes (6): PlacePoolFlowTest, Modifier, SelectPlacesContent(), SavedPlace, EditSavedPlaceDialog(), SavedPlaceRowUi
...
### Community 136 - "CreateTripUiState"
Cohesion: 0.36
...
Cohesion: 0.09
Nodes (8): FakeMapPreferences, Itineraries, ItineraryRepository, Role, MapLayerFlowTest, Places, Modifier, MapLegend()
...
Cohesion: 0.12
Nodes (14): AmapServiceException, parseRouteResult(), RoutePathData, selectUsablePath(), validateRouteRequest(), RouteMode, DRIVE, TRANSIT (+6 more)

### Community 159 - "ItineraryUiModels.kt"
Cohesion: 0.18
Nodes (8): WholeTripItineraryContentTest, mapWholeTripDays(), toItineraryItemUi(), toRouteErrorSummary(), toRouteLegUi(), WholeTripDayUi, DayMapSnapshot, WholeTripItineraryMapperTest
...
### Community 164 - "TripRepository"
Cohesion: 0.14
Nodes (3): Flow, TripRepository, Flow

### Community 166 - "CreateTripContent"
Cohesion: 0.39
Nodes (4): CreateTripContentTest, CreateTripContent(), Modifier, StepNumber()

### Community 167 - "MapPoiUi"
Cohesion: 0.26
Nodes (3): AmapMapHost, PoiHost, MapPoiUi
...
Cohesion: 0.23
Nodes (6): AmapSmokeTest, AmapPlaceDataSource, AmapRouteDataSource, RouteDataSource, RouteDataSource, RouteRequest
...
### Community 179 - "ByteArray"
Cohesion: 0.67
Nodes (3): gitBytes(), sha256(), ByteArray

### Community 181 - "Dp"
Cohesion: 0.13
Nodes (14): EasyTripIconButton(), Modifier, EmptyState(), Modifier, ItineraryItemCard(), ItineraryItemRow(), Color, Modifier (+6 more)

### Community 182 - "WorkspaceSearchReturnNavEntryTest"
Cohesion: 0.25
...
### Community 189 - "V2AcceptanceTest.kt"
Cohesion: 0.11
Nodes (8): AmapMapHost, PlaceSearchDataSource, RecordingHost, V2AcceptanceTest, PlaceSearchDataSource, WorkspaceSection, ITINERARY, PLACE_POOL

### Community 190 - "DayDeleteImpact"
Cohesion: 0.21
Nodes (4): DayDeleteImpact, DeleteImpactProvider, TripDeleteImpact, FakeImpacts

### Community 191 - "BridgeState"
Cohesion: 0.33
Nodes (6): BridgeState, CANCELLED, COMPLETED, READY, STARTED, STARTING

### Community 192 - "ViewportReason"
Cohesion: 0.33
...
- **Why does `GeoPoint` connect `GeoPoint` to `reduceMapInteraction`, `MapUiModelMapperTest`, `MapFacade.kt`, `FakeRepository`, `.setContent`, `SearchSource`, `V1ScenarioExecutableFactory`, `V1ScenarioExecutable.kt`, `AmapComposeMap`, `RoomSavedPlaceRepository`, `TripDay`, `CreateTrip`, `DelayedDeletePlaces`, `parsePlaces`, `TestSavedPlaces`, `SavedPlaceRepository`, `AmapServiceException`, `ItineraryUiModels.kt`, `MapPoiUi`, `RouteRequest`, `MapUiModel`, `PlaceSearchState`, `Dp`, `PoolRepository`, `FakeTrips`, `RoomRouteLegRepositoryTest`, `MapViewportRenderingPolicyTest`, `V2AcceptanceTest.kt`, `FakeSavedPlaces`, `TripWorkspaceViewModel`, `TripWorkspaceNavigationStateTest`, `PlaceCandidate`, `WorkspaceFlowTest`, `AmapPlaceDataSource.kt`, `.Content`, `Legs`, `TransportMode`, `EasyTripDatabase`, `MapViewportControllerTest`, `AmapRouteDataSource.kt`, `RoomRouteLegRepository`, `AddPlacesRequest`, `.mapDetailBackThenPlaceEditRendersNewTarget`, `SavedPlace`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `TripDay` connect `TripDay` to `MapUiModelMapperTest`, `MapFacade.kt`, `TripService`, `Trips`, `V1ScenarioExecutableFactory`, `V1ScenarioExecutable.kt`, `Trips`, `ItineraryUiModels.kt`, `SelectablePill`, `ItineraryScope`, `FakeRepository`, `FakeTrips`, `CompactSecondaryButton`, `FakeRepository`, `TripWorkspaceViewModel`, `TripWorkspaceNavigationStateTest`, `WholeTripItineraryContent`, `FakeTripRepository`, `.workspaceScenario`, `GeoPoint`, `DayItineraryUiState`, `SavedPlace`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `TripRepository` connect `TripRepository` to `TripService`, `TripSettingsViewModel`, `Trips`, `TripDay`, `Legs`, `DayItineraryViewModelTest`, `CreateTrip`, `Trips`, `DateRangeDeletionCounts`, `Trips`, `TravelMode`, `Legs`, `FakeRepository`, `AppNavigation.kt`, `FakeRepository`, `FakeTrips`, `FakeRepository`, `TripWorkspaceViewModel`, `TripSummary`, `TripWorkspaceNavigationStateTest`, `FakeTripRepository`, `Legs`?**
