...
## Corpus Check
- 344 files · ~201,114 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5331 nodes · 11723 edges · 291 communities (248 shown, 43 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 870 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3f6be10b`
...
1. `GeoPoint` - 189 edges
2. `PlaceCandidate` - 137 edges
3. `SavedPlace` - 111 edges
4. `TripDay` - 104 edges
5. `TripService` - 85 edges
6. `CreateTrip` - 83 edges
7. `TravelMode` - 76 edges
8. `PlacePoolViewModel` - 74 edges
9. `TripWorkspaceViewModel` - 71 edges
10. `PlaceSearchViewModel` - 66 edges
...
Cohesion: 0.08
Nodes (26): AddNewTag, AddPresetTag, Back, CancelEdit, ConfirmRemoval, DismissRemovalConfirmation, ExitDestination, Ignore (+18 more)
...
### Community 5 - "PlacePoolViewModel"
Cohesion: 0.11
...
### Community 8 - "TripDateRangeRoomTest"
Cohesion: 0.24
Nodes (4): Content, Snapshot, TripDateRangeRoomTest, Content

### Community 9 - "DayItineraryUiState"
Cohesion: 0.13
Nodes (11): ComposeScenario, com, ScenarioFixture, ScenarioPath, V1ScenarioExecutable, V1ScenarioExecutableFactory, WorkspaceSheetScenarioSpec, DayItineraryUiState (+3 more)
...
### Community 11 - "PlaceDeletionImpact"
Cohesion: 0.12
...
Cohesion: 0.17
Nodes (9): TripListViewModel, TripDeleteImpact, com, CompletableDeferred, CreateTrip, DeleteImpactProvider, TestImpacts, TestTripRepository (+1 more)
...
### Community 16 - "SavedPlaceRepository"
Cohesion: 0.13
Nodes (5): Flow, TestSavedPlaces, AmapPrivacyGate, Flow, SavedPlaceRepository
...
Cohesion: 0.06
Nodes (10): RoomSavedPlaceRepositoryTest, IdFactory, T, MutableClock, RoomTripRepositoryTest, Flow, RoomTripRepository, CreateTrip (+2 more)
...
### Community 23 - "PlacePoolUiState"
Cohesion: 0.16
Nodes (4): androidx, com, TripWorkspaceContentTest, PlacePoolUiState

### Community 24 - "AppNavigation"
Cohesion: 0.08
Nodes (23): V1PencilFlowTest, AppNavigationObserver, AppNavigationObserver, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, AppNavigation() (+15 more)
...
Cohesion: 0.26
Nodes (18): BackIcon(), BookmarkIcon(), CloseIcon(), Color, com, Composable, LazyListState, Modifier (+10 more)

### Community 27 - "Trips"
Cohesion: 0.06
Nodes (10): DayItinerarySelectionTest, Itineraries, com, CompletableDeferred, CreateTrip, Flow, ItineraryRepository, Trips (+2 more)

### Community 28 - "ItineraryScope"
Cohesion: 0.15
...
### Community 34 - "PlaceSearchViewModel"
Cohesion: 0.12
Nodes (8): PendingCollectionRemoval, Factory, T, ViewModelProvider, MapDetail, PlaceSearchViewModel, Results, SearchDisplayMode
...
### Community 37 - "WorkspaceFlowTest.kt"
Cohesion: 0.05
Nodes (11): AppIconResourceTest, CascadeDeleteTest, RoomRouteLegRepositoryTest, V1AcceptanceTest, EasyTripDatabase, com, AlreadySaved, Saved (+3 more)
...
Cohesion: 0.08
Nodes (12): Flow, Flow, Flow, Flow, RouteLegRepository, RouteLegWithEndpoints, RouteResult, Failure (+4 more)
...
### Community 42 - "RealAmapMapHost"
Cohesion: 0.10
Nodes (4): AmapMapHost, android, View, RealAmapMapHost

### Community 43 - "decideCollectionToggle"
Cohesion: 0.27
...
Cohesion: 0.12
Nodes (24): EmptyState(), Composable, Modifier, AddPlace, AddPlaces, AppendTripDay, CommitMove, ConfirmDelete (+16 more)
...
### Community 46 - "GeoPoint"
Cohesion: 0.11
Nodes (7): CoroutineScope, V2AcceptanceTest, GeoPoint, PlaceSearchDataSource, Result, PolylineCodec, PolylineCodecTest
...
### Community 50 - "LongNameTrips"
Cohesion: 0.07
Nodes (4): com, CreateTrip, LongNameTrips, NoDayTrips
...
### Community 53 - "RoomSavedPlaceRepository"
Cohesion: 0.09
Nodes (11): com, PlaceSearchDataSource, PlacePoolFlowTest, com, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, Flow (+3 more)
...
### Community 57 - "LocationPermissionCoordinator.kt"
Cohesion: 0.28
Nodes (8): StateFlow, LocationPermissionRequestStore, OpenApplicationSettings, RequestLocationPermission, SavedStateLocationPermissionRequestStore, SharedPreferencesLocationPermissionRequestStore, ShowCurrentLocation, WorkspaceEffect

### Community 58 - "V1ScenarioExecutable.kt"
Cohesion: 0.09
Nodes (25): WorkspacePermissionFlowTest, CompactPrimaryButton(), CompactSecondaryButton(), AddTripDayContent(), EditItineraryItemContent(), Modifier, Modifier, SelectPlacesContent() (+17 more)
...
### Community 60 - "IllegalStateException"
Cohesion: 0.12
Nodes (8): FakeImpacts, FakeRepository, CompletableDeferred, DeleteImpactProvider, FakeRepository, TripSettingsViewModelTest, Continuation, IllegalStateException
...
### Community 67 - "TripWorkspaceContent"
Cohesion: 0.12
Nodes (20): WorkspacePlacePoolLayoutTest, Composable, Modifier, TripWorkspaceContent(), WorkspacePageMessage(), WorkspaceReadyContent(), WorkspaceSheetHandle(), TripWorkspaceUiState (+12 more)

### Community 68 - "DayItinerary"
Cohesion: 0.16
...
### Community 75 - "TripListViewModel.kt"
Cohesion: 0.10
...
### Community 83 - "AddToItineraryUiState"
Cohesion: 0.21
Nodes (14): ConfirmationUiModel, AddToItineraryUiState, CrossDayMoveDraft, ItineraryDeleteConfirmation, ItineraryEditDraft, RouteModeEditDraft, addOverlayToPresent(), canDismissAddOverlay() (+6 more)

### Community 86 - "Legs"
Cohesion: 0.10
Nodes (3): com, Flow, Legs

### Community 87 - "BackLockRepository"
Cohesion: 0.15
Nodes (3): BackLockRepository, com, Flow

### Community 88 - "TripWorkspaceScreen"
Cohesion: 0.14
Nodes (5): AmapMapHost, RecordingHost, PoiHost, MapPoiUi, TripWorkspaceScreen()

### Community 89 - "TripService"
Cohesion: 0.13
Nodes (6): com, TripService, FakeTripRepository, CreateTrip, Flow, TripServiceTest

### Community 90 - "TripRepository.kt"
Cohesion: 0.09
Nodes (18): CreateTrip, isTripDateRangeRepresentable(), tripEndDateOrNull(), CreateTrip, Back, CreateTimeMode, DATED, DRAFT (+10 more)

### Community 91 - "BlockingRepository"
Cohesion: 0.11
...
### Community 108 - "LocationPermissionCoordinator"
Cohesion: 0.08
Nodes (12): Itineraries, ItineraryRepository, Legs, Places, Trips, WorkspaceFlowTest, UndoAddedItemsUseCase, T (+4 more)

### Community 109 - "TripListContent"
Cohesion: 0.29
Nodes (10): InlineStatus(), Modifier, Modifier, TripListContent(), TripListHeader(), EmptyTrips(), Modifier, LuggageIllustration() (+2 more)
...
Cohesion: 0.11
Nodes (6): com, CreateTrip, SavedStateHandle, Trips, Trips, TripWorkspaceNavigationStateTest
...
### Community 130 - "Flow"
Cohesion: 0.05
Nodes (6): BlockingSavedPlaces, CoordinateRequiringSavedPlaces, DelayedImpactSavedPlaces, FailingThenBlockingRemovalSavedPlaces, Flow, OverlappingCollectionSavedPlaces
...
### Community 136 - "TravelMode"
Cohesion: 0.10
Nodes (10): TravelMode, FLEXIBLE, SELF_DRIVE, defaultRecommendMode(), haversineMeters(), Flow, SavedPlaceEntity, TransportModeRecommender (+2 more)
...
### Community 145 - "SchemaTest"
Cohesion: 0.11
Nodes (5): Fixture, SchemaTest, SchemaPlaceDao, SavedPlaceTagCrossRef, TagEntity
...
### Community 147 - "AmapRouteDataSource.kt"
Cohesion: 0.08
...
### Community 148 - "DateRangeChangeImpact"
Cohesion: 0.19
Nodes (3): DateRangeApply, DateRangeChangeImpact, DateRangeChangeUiState

### Community 149 - "TripDay"
Cohesion: 0.08
Nodes (18): ItineraryScopeRailTest, WholeTripItineraryContentTest, ItineraryEmptyIllustration(), Modifier, ItineraryScopeRail(), Modifier, ScopeItem(), WholeTripDayUi (+10 more)
...
### Community 153 - "MapFacade.kt"
Cohesion: 0.14
Nodes (13): formatOccurrenceBadge(), MapMarkerUi, MapPolylineUi, MapRouteLabelUi, MapScope, PLACE_POOL, SINGLE_DAY, WHOLE_TRIP (+5 more)
...
### Community 178 - "TripListContentTest"
Cohesion: 0.28
Nodes (3): T, TripListContentTest, TripListUiState

### Community 180 - "TripWorkspaceViewModel"
Cohesion: 0.10
Nodes (17): Factory, CreationExtras, Flow, ItineraryRepository, java, Job, StateFlow, T (+9 more)

### Community 181 - "ConfirmationDialog"
Cohesion: 0.15
Nodes (22): ActionStyle, DANGER, PRIMARY, SECONDARY, CompactActionButton(), CompactDangerButton(), Modifier, ConfirmationDialog() (+14 more)

### Community 183 - "TripCardUiModel"
Cohesion: 0.23
Nodes (12): Modifier, MoreIcon(), OtherTripRow(), PrimaryTripCard(), TripMenu(), Content, Empty, Error (+4 more)
...
Cohesion: 0.26
Nodes (5): TripSettingsContentTest, TripSettingsContent(), DayUi, PendingDayDeletion, TripSettingsUiState

### Community 187 - "WorkspaceSearchReturn"
Cohesion: 0.09
...
### Community 218 - "ItineraryUiModels.kt"
Cohesion: 0.21
Nodes (11): Calculating, Failed, mapWholeTripDays(), Ready, RouteLegUiState, toItineraryItemUi(), toRouteErrorSummary(), toRouteLegUi() (+3 more)

### Community 219 - "MapView"
Cohesion: 0.20
...
### Community 243 - "WorkspaceTopBar"
Cohesion: 0.22
Nodes (5): WorkspaceChromeTest, Modifier, WorkspaceTabs(), Modifier, WorkspaceTopBar()
...
### Community 246 - "MapLayerFlowTest"
Cohesion: 0.16
...
### Community 266 - "reduceMapInteraction"
Cohesion: 0.27
...
### Community 273 - "DateRangeChangePhase"
Cohesion: 0.25
...
### Community 281 - "RoutePlannerTest"
Cohesion: 0.38
Nodes (3): RouteDataSource, RoutePlannerTest, RouteDataSource

### Community 282 - "TripWithDays"
Cohesion: 0.07
Nodes (10): TripWithDays, DeletingDayItineraries, Itineraries, CreateTrip, ItineraryRepository, Trips, Places, Trips (+2 more)
...
### Community 286 - "AddToItineraryStep"
Cohesion: 0.40
...
### Community 288 - "RoomItineraryRepository"
Cohesion: 0.18
Nodes (6): ItineraryItemEntity, ItineraryRepository, RoomItineraryRepository, AdjacencyDiff, Edge, AdjacencyPlannerTest

### Community 290 - "MapLayer"
Cohesion: 0.10
Nodes (10): AmapMapHost, View, AmapMapHost, AmapMapHost, TestMapHost, MapLayer, SATELLITE_ROAD, STANDARD (+2 more)

### Community 291 - "SavedPlaceRow"
Cohesion: 0.90
Nodes (4): Modifier, MoreIcon(), PlusIcon(), SavedPlaceRow()

### Community 293 - "AmapConsentToken"
Cohesion: 0.27
Nodes (4): AmapConsentToken, AppContainer, CoroutineScope, PlaceService

### Community 295 - "TripDeletionUiState"
Cohesion: 0.40
Nodes (5): Idle, ImpactFailure, LoadingImpact, Ready, TripDeletionUiState

### Community 297 - "AmapComposeMapTest.kt"
Cohesion: 0.19
Nodes (8): AmapComposeMapTest, Lifecycle, LifecycleOwner, TestOwner, Bundle, ComponentActivity, MainActivity, toMapPoiUi()

### Community 299 - "ItineraryRepository"
Cohesion: 0.22
Nodes (4): Flow, ItineraryRepository, java, ItineraryRepository

## Knowledge Gaps
- **1194 isolated node(s):** `guard-adb-install.sh script`, `TRIP_LIST`, `CREATE_TRIP`, `DATE_PICKER`, `WORKSPACE` (+1189 more)
...
- **Why does `GeoPoint` connect `GeoPoint` to `MapUiModelMapperTest`, `FakeRepository`, `TripDateRangeRoomTest`, `DayItineraryUiState`, `TravelMode`, `TransportMode`, `PlaceDeletionImpact`, `PlaceSearchReducer`, `reduceMapInteraction`, `SavedPlaceRepository`, `CreateTrip`, `AmapRouteDataSource.kt`, `SearchMapFocusTest.kt`, `TripDay`, `PlacePoolUiState`, `AppNavigation`, `MapFacade.kt`, `.modelWithResult`, `RoutePlannerTest`, `MapLayer`, `WorkspaceFlowTest.kt`, `RouteLegRepository`, `AmapComposeMapTest.kt`, `AmapPlaceDataSource.kt`, `decideCollectionToggle`, `.setContent`, `TripSettingsNavigationTest`, `TripWorkspaceViewModel`, `RoomSavedPlaceRepository`, `FakeTrips`, `V1ScenarioExecutable.kt`, `SavedPlace`, `View`, `TripWorkspaceContent`, `DayItinerary`, `DelayedDeletePlaces`, `ViewportReason`, `RetryImpactPlaces`, `AddToItineraryUiState`, `AmapComposeMap`, `TripWorkspaceScreen`, `ItineraryUiModels.kt`, `PlaceCandidate`, `MapViewportControllerTest`, `LocationPermissionCoordinator`, `TripWorkspaceNavigationStateTest`, `AddPlacesToDayUseCase`, `.Content`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `TripRepository` connect `TripRepository` to `DayItineraryViewModel`, `TripListViewModel`, `Trips`, `DayItineraryViewModelTest`, `SearchMapFocusTest.kt`, `CreateTrip`, `DateRangeChangeImpact`, `AppNavigation`, `TripWithDays`, `Trips`, `FakeRepository`, `WorkspaceFlowTest.kt`, `TripSettingsViewModel.kt`, `RouteLegRepository`, `LongNameTrips`, `TripWorkspaceViewModel`, `FakeRepository`, `FakeTripRepository`, `FakeTrips`, `IllegalStateException`, `DayItinerary`, `TripListViewModel.kt`, `AddToItineraryUiState`, `BackLockRepository`, `TripService`, `TripRepository.kt`, `BlockingRepository`, `DateRangeDeletionCounts`, `LocationPermissionCoordinator`, `TripWorkspaceNavigationStateTest`, `Legs`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `PlaceCandidate` connect `PlaceCandidate` to `MapUiModelMapperTest`, `Flow`, `PlaceSearchAction`, `PlacePoolViewModel`, `TripDateRangeRoomTest`, `DayItineraryUiState`, `PlaceSearchReducer`, `reduceMapInteraction`, `PlaceDeletionImpact`, `SavedPlaceRepository`, `CreateTrip`, `SearchMapFocusTest.kt`, `Places`, `AppNavigation`, `MapFacade.kt`, `PlaceSearchContent.kt`, `TripWithDays`, `WorkspaceFlowTest.kt`, `DelayedRepository`, `RouteLegRepository`, `AmapPlaceDataSource.kt`, `decideCollectionToggle`, `DelayedDetailSavedPlaces`, `GeoPoint`, `.setContent`, `TripSettingsNavigationTest`, `TripWorkspaceViewModel`, `RoomSavedPlaceRepository`, `V1ScenarioExecutable.kt`, `SavedPlace`, `DelayedDeletePlaces`, `ViewportReason`, `RetryImpactPlaces`, `Flow`, `AddToItineraryUiState`, `PlacePoolContent`, `Places`, `DelayedCollectionRepository`, `LocationPermissionCoordinator`, `Legs`?**
