...
## Corpus Check
- 298 files · ~157,116 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4176 nodes · 8903 edges · 227 communities (179 shown, 48 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 600 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5b209b0d`
...
## Communities (227 total, 48 thin omitted)
...
Cohesion: 0.13
Nodes (5): DayItineraryViewModel, StateFlow, ViewModel, CrossDayMoveDraft, RouteModeEditDraft

### Community 14 - "TripWorkspaceRoute.kt"
Cohesion: 0.08
Nodes (34): ConfirmationUiModel, ItineraryDeleteConfirmation, ItineraryEditDraft, addOverlayToPresent(), AppendDayCompletionDecision, canDismissAddOverlay(), canDismissWorkspaceOverlay(), CloseOverlayAndConsume (+26 more)
...
Cohesion: 0.06
Nodes (10): CascadeDeleteTest, RoomSavedPlaceRepositoryTest, IdFactory, T, MutableClock, RoomTripRepositoryTest, Flow, RoomTripRepository (+2 more)
...
### Community 34 - "EasyTripDatabase"
Cohesion: 0.10
Nodes (9): AppIconResourceTest, TripDateRangeRoomTest, V1AcceptanceTest, V1PencilFlowTest, EasyTripDatabase, com, Clock, Context (+1 more)
...
### Community 64 - "TransportMode"
Cohesion: 0.12
Nodes (10): TransportMode, DRIVE, TAXI, TRANSIT, WALK, defaultRecommendMode(), haversineMeters(), SavedPlaceEntity (+2 more)
...
Cohesion: 0.10
Nodes (11): Flow, GeoPoint, Flow, DayItinerary, ItineraryItem, ItineraryPlace, ItineraryRepository, Flow (+3 more)
...
Cohesion: 0.08
Nodes (8): Itineraries, com, ItineraryRepository, Places, PoiHost, Trips, WorkspaceFlowTest, MapPoiUi
...
Cohesion: 0.19
Nodes (12): AppNavigation(), AppNavigationDependencies, AppNavigationObserver, android, com, tripSearchRoute(), WorkspaceSearchReturnViewModel, AmapPlaceDataSource (+4 more)
...
### Community 93 - "RouteLegRepository"
Cohesion: 0.06
...
### Community 97 - "ItineraryItemRow"
Cohesion: 0.12
Nodes (18): ItineraryTimelineContentTest, ItineraryItemMenu(), ItineraryItemMenuAction, Delete, EditTiming, MoveToOtherDay, Modifier, MenuItem() (+10 more)
...
### Community 109 - "CallbackBoundary"
Cohesion: 0.12
...
### Community 112 - "FakeTrips"
Cohesion: 0.12
Nodes (4): FakeTrips, com, CreateTrip, java

### Community 113 - "WholeTripItineraryContent"
Cohesion: 0.23
...
### Community 124 - "RoomSavedPlaceRepository"
Cohesion: 0.09
Nodes (10): PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, AppContainer, CoroutineScope, Flow, RoomSavedPlaceRepository (+2 more)
...
### Community 136 - "PermissionExplanationContent"
Cohesion: 0.20
...
### Community 145 - "MapLayerFlowTest"
Cohesion: 0.16
...
### Community 157 - "DayItineraryUiState"
Cohesion: 0.13
...
Cohesion: 0.11
Nodes (15): PlaceCandidate, PlaceSearchDataSource, AlreadySaved, Flow, PlaceTag, Saved, SavedPlace, SavedPlaceRepository (+7 more)
...
### Community 171 - "ItineraryRepository"
Cohesion: 0.25
...
Cohesion: 0.21
Nodes (11): mapWholeTripDays(), WholeTripDayUi, DayMapSnapshot, Flow, ItineraryRepository, observeSnapshots(), restoreWorkspaceTab(), WorkspaceTab (+3 more)
...
Cohesion: 0.29
Nodes (7): Failed, Ready, RouteLegUiState, toItineraryItemUi(), toRouteErrorSummary(), toRouteLegUi(), WaitingForNetwork

### Community 192 - ".realNavigationEntersWorkspaceSearchesReturnsAndSwitchesSections"
Cohesion: 0.29
Nodes (4): CreateTrip, PlaceSearchDataSource, PlaceSearchDataSource, InMemoryLocationPermissionRequestStore

### Community 194 - "CascadeCountDao"
Cohesion: 0.06
...
### Community 206 - "RouteLegContent"
Cohesion: 0.70
Nodes (4): Modifier, modeLabel(), RouteLegContent(), RouteLegRow()

### Community 207 - "ViewportReason"
Cohesion: 0.33
...
## Knowledge Gaps
- **805 isolated node(s):** `guard-adb-install.sh script`, `TRIP_LIST`, `CREATE_TRIP`, `DATE_PICKER`, `WORKSPACE` (+800 more)
...
- **Why does `GeoPoint` connect `GeoPoint` to `MapUiModelMapperTest`, `FakeRepository`, `TripWorkspaceContentTest`, `PlaceSearchEvidenceTest`, `V1ScenarioExecutableFactory`, `RouteStatus`, `RealAmapMapHost`, `.searchCollectionAndMapFlowUsesProductionNavigationState`, `CreateTrip`, `RoutePlannerTest`, `TestSavedPlaces`, `TripDay`, `DayItineraryUiState`, `TripWorkspaceNavigationStateTest`, `PlaceCandidate`, `EasyTripDatabase`, `MapUiModel`, `AmapServiceException`, `MapFacade.kt`, `.Content`, `TripWorkspaceViewModel.kt`, `PlacePoolViewModel`, `FakeItineraries`, `EditingPlaces`, `CompactSecondaryButton`, `MapViewportController`, `PlaceSearchViewModel`, `TripWorkspaceViewModel`, `.realNavigationEntersWorkspaceSearchesReturnsAndSwitchesSections`, `AmapSmokeTest`, `MapViewportControllerTest`, `parsePlaces`, `.model`, `MapViewportRenderingPolicyTest`, `WorkspaceFlowTest`, `AmapPlaceDataSource.kt`, `reduceMapInteraction`, `Legs`, `RoomRouteLegRepository`, `RouteLegRepository`, `V1ScenarioExecutable.kt`, `AmapRouteDataSource.kt`, `DelayedDeletePlaces`, `AddPlacesRequest`, `RoomSavedPlaceRepository`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `PlaceCandidate` connect `PlaceCandidate` to `MapUiModelMapperTest`, `PlaceSearchEvidenceTest`, `Trips`, `V1ScenarioExecutableFactory`, `TripWorkspaceRoute.kt`, `CreateTrip`, `TestSavedPlaces`, `Places`, `TripDay`, `DayItineraryUiState`, `EasyTripDatabase`, `Legs`, `MapFacade.kt`, `TripWorkspaceViewModel.kt`, `PlacePoolViewModel`, `EditingPlaces`, `CompactSecondaryButton`, `PlaceSearchViewModel`, `TripWorkspaceViewModel`, `.realNavigationEntersWorkspaceSearchesReturnsAndSwitchesSections`, `parsePlaces`, `GeoPoint`, `WorkspaceFlowTest`, `AmapPlaceDataSource.kt`, `reduceMapInteraction`, `Legs`, `RouteLegRepository`, `V1ScenarioExecutable.kt`, `Places`, `PlacePoolContent`, `DelayedDeletePlaces`, `RoomSavedPlaceRepository`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `TripRepository` connect `TripDay` to `FakeTripRepository`, `TripSettingsViewModel`, `Trips`, `Trips`, `DayItineraryViewModelTest`, `FakeRepository`, `CreateTrip`, `TripListViewModel`, `Trips`, `PlaceCandidate`, `Legs`, `DateRangeApply`, `TripWorkspaceViewModel.kt`, `FakeRepository`, `Trips`, `DateRangeDeletionCounts`, `FakeRepository`, `TestTripRepository`, `GeoPoint`, `RecordingTripRepository`, `FakeTripRepository`, `WorkspaceFlowTest`, `AppNavigation.kt`, `Legs`, `RouteLegRepository`, `FakeTrips`, `LongNameTrips`?**
