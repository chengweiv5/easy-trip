...
8. `TripService` - 52 edges
9. `TransportMode` - 51 edges
...
Cohesion: 0.12
Nodes (19): WholeTripItineraryContentTest, ItineraryItemCard(), ItineraryItemRow(), Color, Modifier, semanticsActions(), ItineraryItemUi, RouteLegUi (+11 more)
...
Cohesion: 0.06
Nodes (11): CascadeDeleteTest, RoomSavedPlaceRepositoryTest, IdFactory, T, MutableClock, RoomTripRepositoryTest, V1PencilFlowTest, Flow (+3 more)
...
Cohesion: 0.07
Nodes (10): CreateTrip, Flow, RecordingTripRepository, Role, InsertSide, AFTER, BEFORE, Flow (+2 more)
...
### Community 34 - "Dp"
Cohesion: 0.08
Nodes (18): ConfirmationDialogTest, SelectablePillTest, EasyTripIconButton(), Modifier, EmptyState(), Modifier, Modifier, Role (+10 more)
...
Cohesion: 0.17
Nodes (19): AddPlace, AddPlaces, AppendTripDay, CommitMove, ConfirmDelete, DayItineraryAction, DayItineraryContent(), DayItinerarySheet() (+11 more)
...
Cohesion: 0.10
Nodes (26): description(), Modifier, MapControls(), Modifier, SearchSurface(), Composable, Modifier, LayerIcon() (+18 more)

### Community 50 - "AddToItineraryUiState"
Cohesion: 0.08
Nodes (33): ConfirmationUiModel, AddToItineraryUiState, DayItineraryUiState, PlacePoolUiState, addOverlayToPresent(), canDismissAddOverlay(), confirmation(), isAddToItineraryOverlay() (+25 more)
...
Cohesion: 0.07
Nodes (22): Flow, Flow, Flow, Flow, AlreadySaved, Flow, PlaceTag, Saved (+14 more)
...
Cohesion: 0.21
Nodes (16): CompactPrimaryButton(), CompactSecondaryButton(), AddTripDayContent(), EditTimingDialog(), Modifier, SelectPlacesContent(), Modifier, PlaceDetailContent() (+8 more)
...
Cohesion: 0.09
Nodes (18): AmapComposeMapTest, AmapMapHost, Lifecycle, LifecycleOwner, TestOwner, FocusSearchResult, MapInteractionAction, MapMarkerKind (+10 more)
...
Cohesion: 0.05
Nodes (11): Itineraries, com, CreateTrip, ItineraryRepository, SavedStateHandle, Trips, Legs, MutableItineraries (+3 more)
...
Cohesion: 0.15
Nodes (6): FakeImpacts, FakeTripRepository, CreateTrip, Flow, MoveCall, TripFlowTest
...
Cohesion: 0.09
Nodes (12): AppIconResourceTest, AmapPlaceDataSource, CallbackBoundary, PoiSearch, CallbackBoundary, com, parsePoiSearchResponse(), PlaceCandidate (+4 more)
...
### Community 130 - "V1AcceptanceTest.kt"
Cohesion: 0.20
Nodes (3): V1AcceptanceTest, MapUiModelMapper, routePalette()
...
Cohesion: 0.10
Nodes (15): ClearedProbe, ViewModel, WorkspaceSearchReturnNavEntryTest, Bundle, ComponentActivity, WorkspaceSearchReturnTestActivity, consumeWorkspaceSearchReturn(), androidx (+7 more)
...
### Community 142 - "DayItineraryViewModel.kt"
Cohesion: 0.29
...
### Community 154 - "TripDay"
Cohesion: 0.08
Nodes (22): ItineraryScopeRailTest, ItineraryScopeRail(), Modifier, ScopeItem(), Modifier, SelectTargetDayContent(), Modifier, WorkspaceItineraryContent() (+14 more)
...
Cohesion: 0.08
Nodes (13): PlaceSearchDataSource, PlacePoolFlowTest, PlaceSearchDataSource, PlaceSearchDataSource, PlaceSearchDataSource, GeoPoint, Flow, RoomSavedPlaceRepository (+5 more)
...
- **Why does `GeoPoint` connect `GeoPoint` to `Legs`, `MapUiModelMapperTest`, `V1AcceptanceTest.kt`, `FakeRepository`, `FakeItineraries`, `AmapComposeMap.kt`, `AmapMapHost`, `RouteStatus`, `CreateTrip`, `.setContent`, `RoutePlannerTest`, `DayItinerary`, `AmapServiceException`, `DelayedDeletePlaces`, `parsePlaces`, `SavedPlace`, `PlacePoolViewModel`, `MapUiModel`, `PlaceSearchViewModel`, `TripWorkspaceViewModel`, `TripWorkspaceNavigationStateTest`, `TripWorkspaceScreen`, `PlaceCandidate`, `.Content`, `EditingPlaces`, `PlaceSearchEvidenceTest`, `reduceMapInteraction`, `MapViewportRenderingPolicyTest`, `MapViewportControllerTest`, `TravelMode`, `AmapRouteDataSource.kt`, `AmapSmokeTest`, `.searchCollectionMapAndRestorationFlow`, `RoomRouteLegRepository`, `AddPlacesRequest`, `TestSavedPlaces`?**
